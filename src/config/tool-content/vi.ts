 ...
 *
 * Vietnamese tool content - contains detailed descriptions, usage instructions, use cases and FAQs for PDF tools
 */
...
export const toolContentVn: Record<string, ToolContent> = {
  "pdf-multi-tool": {
    ...
    metaDescription:
      "Công cụ chỉnh sửa PDF toàn diện: hợp nhất, tách, tổ chức, xóa, xoay và trích xuất trang trong một công cụ mạnh mẽ.",
    keywords: [
      "công cụ đa năng pdf",
      "chỉnh sửa pdf",
      "hợp nhất pdf",
    ...
    howToUse: [
      {
        ...
        description:
          "Kéo và thả tệp PDF của bạn vào khu vực tải lên, hoặc nhấp để duyệt và chọn tệp từ thiết bị của bạn.",
      },
      {
        step: 2,
        title: "Chọn thao tác của bạn",
        description:
          "Chọn từ các thao tác có sẵn: hợp nhất, tách, tổ chức, xóa trang, xoay, thêm trang trống hoặc trích xuất trang.",
      },
      {
        step: 3,
        title: "Định cấu hình tùy chọn",
        description:
          "Điều chỉnh cài đặt cụ thể cho thao tác đã chọn của bạn, chẳng hạn như phạm vi trang, góc xoay hoặc thứ tự hợp nhất.",
      },
      {
        step: 4,
        title: "Xử lý và tải xuống",
        description:
          "Nhấp nút xử lý và tải xuống PDF đã sửa đổi của bạn sau khi thao tác hoàn thành.",
      },
    ],
    useCases: [
      {
        ...
        description:
          "Chuẩn bị tài liệu để nộp bằng cách loại bỏ các trang không cần thiết, sắp xếp lại nội dung và kết hợp nhiều tệp thành một tài liệu chuyên nghiệp.",
        icon: "file-check",
      },
      {
        title: "Lắp ráp báo cáo",
        description:
          "Kết hợp nhiều phần báo cáo, thêm trang bìa và tổ chức các chương thành một tài liệu mạch lạc duy nhất.",
        icon: "book-open",
      },
      {
        title: "Quản lý lưu trữ",
        description:
          "Tách các tệp lưu trữ lớn thành các phần có thể quản lý, trích xuất các trang liên quan và sắp xếp lại tài liệu lịch sử.",
        icon: "archive",
      },
    ],
    faq: [
      {
        ...
        answer:
          "Bạn có thể tải lên và xử lý tối đa 10 tệp PDF cùng lúc, với tổng kích thước kết hợp tối đa 500MB.",
      },
      {
        question: "Đánh dấu trang của tôi có được bảo toàn không?",
        answer:
          "Có, khi hợp nhất PDF, công cụ bảo toàn đánh dấu trang hiện có và có thể kết hợp chúng thành cấu trúc đánh dấu trang thống nhất.",
      },
      {
        question: "Có giới hạn trang không?",
        answer:
          "Không có giới hạn trang nghiêm ngặt. Công cụ có thể xử lý tài liệu có hàng trăm trang, mặc dù các tệp lớn hơn có thể mất nhiều thời gian hơn để xử lý.",
      },
    ],
  },
  "merge-pdf": {
    title: "Hợp nhất PDF",
    metaDescription:
      "Kết hợp nhiều tệp PDF thành một tài liệu. Công cụ hợp nhất PDF trực tuyến miễn phí với kéo và thả để sắp xếp lại.",
    keywords: [
      "hợp nhất pdf",
      "kết hợp pdf",
      "nối pdf",
    ...
    howToUse: [
      {
        ...
        description:
          "Kéo và thả nhiều tệp PDF vào khu vực tải lên, hoặc nhấp để chọn tệp từ thiết bị của bạn.",
      },
      {
        step: 2,
        title: "Sắp xếp thứ tự",
        description:
          "Kéo và thả hình thu nhỏ tệp để sắp xếp chúng theo thứ tự mong muốn.",
      },
      {
        step: 3,
        title: "Hợp nhất và tải xuống",
        description:
          "Nhấp nút Hợp nhất để kết hợp tất cả tệp, sau đó tải xuống PDF đã hợp nhất của bạn.",
      },
    ],
    useCases: [
      {
        ...
        description:
          "Hợp nhất báo cáo hàng tháng hoặc hàng quý thành một tài liệu hàng năm duy nhất để phân phối và lưu trữ dễ dàng hơn.",
        icon: "file-text",
      },
      {
        title: "Lắp ráp danh mục đầu tư",
        description:
          "Kết hợp nhiều tài liệu dự án, chứng chỉ hoặc mẫu công việc thành một danh mục đầu tư chuyên nghiệp.",
        icon: "briefcase",
      },
      {
        title: "Hợp nhất hóa đơn",
        description:
          "Hợp nhất nhiều hóa đơn hoặc biên lai thành một tài liệu duy nhất để kế toán và lưu trữ hồ sơ.",
        icon: "receipt",
      },
    ],
    faq: [
      {
        ...
        answer:
          "Bạn có thể hợp nhất tối đa 100 tệp PDF cùng lúc, với tổng kích thước kết hợp tối đa 500MB.",
      },
      {
        question: "PDF đã hợp nhất có bảo toàn chất lượng gốc không?",
        answer:
          "Có, quá trình hợp nhất bảo toàn chất lượng gốc của tất cả tài liệu mà không có bất kỳ nén hoặc mất chất lượng nào.",
      },
      {
        question: "Tôi có thể hợp nhất PDF được bảo vệ bằng mật khẩu không?",
        answer:
          "PDF được bảo vệ bằng mật khẩu cần được giải mã trước. Sử dụng công cụ Giải mã PDF của chúng tôi để xóa mật khẩu trước khi hợp nhất.",
      },
    ],
  },
  "rotate-custom": {
    ...
    metaDescription:
      "Xoay trang PDF theo bất kỳ góc độ nào. Xoay tùy chỉnh chính xác cho tài liệu đã quét bị lệch.",
    keywords: [
    ...
    howToUse: [
      ...
      },
      {
        ...
        title: "Đặt góc xoay",
        description:
          "Nhập độ xoay chính xác cho từng trang, hoặc đặt góc hàng loạt cho tất cả trang.",
      },
      {
        step: 3,
        title: "Xem trước và điều chỉnh",
        description:
          "Sử dụng xem trước thời gian thực để đảm bảo các trang được căn chỉnh hoàn hảo.",
      },
      {
        step: 4,
        title: "Áp dụng và tải xuống",
        description:
          "Nhấp Xoay để áp dụng các thay đổi và tải xuống PDF đã làm thẳng của bạn.",
      },
    ],
    useCases: [
      {
        ...
        description:
          "Làm thẳng các trang đã quét được đưa vào máy quét theo góc độ.",
        icon: "scan",
      },
      {
        title: "Bản vẽ kỹ thuật",
        description:
          "Điều chỉnh định hướng của bản vẽ kỹ thuật và kế hoạch với độ chính xác.",
        icon: "ruler",
      },
      {
        title: "Bố cục sáng tạo",
        description:
          "Tạo bố cục độc đáo bằng cách xoay trang theo góc nghệ thuật cụ thể.",
        icon: "pen-tool",
      },
    ],
    faq: [
      {
        ...
        answer:
          "Hiện tại công cụ hỗ trợ độ nguyên, nhưng chúng tôi đang làm việc để kích hoạt độ chính xác thập phân.",
      },
      {
        question: "Điều này có ảnh hưởng đến nội dung trang không?",
        answer:
          "Nội dung được xoay trực quan. Kích thước trang được điều chỉnh tự động để phù hợp với nội dung đã xoay.",
      },
      {
        question: "Tôi có thể xoay chỉ một trang không?",
        answer:
          "Có, bạn có thể đặt góc xoay tùy chỉnh cho bất kỳ trang riêng lẻ nào trong khi để các trang khác không thay đổi.",
      },
    ],
  },
  "grid-combine": {
    ...
    metaDescription:
      "Kết hợp nhiều tệp PDF lên các trang đơn với bố cục lưới linh hoạt. Sắp xếp 2, 4, 6, 9 hoặc nhiều PDF hơn mỗi trang với đường viền và khoảng cách.",
    keywords: [
      "kết hợp lưới",
      "hợp nhất pdf lưới",
      "bố cục pdf",
    ...
    howToUse: [
      {
        ...
        title: "Tải lên tệp PDF",
        description:
          "Tải lên hai hoặc nhiều tệp PDF bạn muốn kết hợp. Bạn có thể sắp xếp lại chúng theo thứ tự mong muốn.",
      },
      {
        step: 2,
        title: "Chọn bố cục lưới",
        description:
          "Chọn bố cục lưới mong muốn của bạn (ví dụ: 2x2 cho 4 tệp mỗi trang, 3x3 cho 9 tệp mỗi trang).",
      },
      {
        step: 3,
        title: "Tùy chỉnh giao diện",
        description:
          "Điều chỉnh cài đặt như kích thước trang (A4, Letter), định hướng, khoảng cách giữa các mục và đường viền.",
      },
      {
        step: 4,
        title: "Kết hợp và tải xuống",
        description:
          'Nhấp "Kết hợp PDF" để tạo bố cục lưới mới của bạn và tải xuống kết quả.',
      },
    ],
    useCases: [
      {
        ...
        description:
          "Đặt các phiên bản khác nhau của thiết kế hoặc tài liệu cạnh nhau trên một trang để so sánh dễ dàng.",
        icon: "layout-grid",
      },
      {
        title: "In tài liệu phân phát",
        description:
          "Kết hợp nhiều tài liệu ngắn hoặc trang trình bày lên một tờ giấy để tiết kiệm chi phí in ấn.",
        icon: "printer",
      },
      {
        title: "Tạo danh mục đầu tư",
        description:
          "Trưng bày nhiều tệp dự án trong tổng quan lưới sạch sẽ, có tổ chức.",
        icon: "image",
      },
    ],
    faq: [
      {
        ...
        answer:
          "N-Up lấy trang từ MỘT PDF và đặt chúng lên một tờ. Kết hợp lưới lấy NHIỀU tệp PDF khác nhau và đặt chúng lên một tờ.",
      },
      {
        question: "Tôi có thể kết hợp bao nhiêu tệp?",
        answer:
          "Bạn có thể kết hợp tối đa 100 tệp tùy thuộc vào bộ nhớ trình duyệt của bạn, nhưng các bố cục như 4x4 có thể chứa tối đa 16 tệp mỗi trang.",
      },
      {
        question: "Tôi có thể thêm đường viền không?",
        answer:
          "Có, bạn có thể thêm đường viền xung quanh mỗi tệp PDF và tùy chỉnh màu đường viền.",
      },
    ],
  },
  "split-pdf": {
    title: "Tách PDF",
    metaDescription:
      "Tách tệp PDF thành nhiều tài liệu. Trích xuất trang cụ thể hoặc chia theo phạm vi trang.",
    keywords: [
      "tách pdf",
      "chia pdf",
      "tách riêng pdf",
    ...
    howToUse: [
      {
        ...
        title: "Tải lên PDF của bạn",
        description:
          "Kéo và thả tệp PDF của bạn hoặc nhấp để duyệt và chọn tệp bạn muốn tách.",
      },
      {
        step: 2,
        title: "Chọn phương pháp tách",
        description:
          "Chọn cách tách: theo phạm vi trang, trích xuất trang cụ thể hoặc tách theo khoảng thời gian đều đặn.",
      },
      {
        step: 3,
        title: "Xác định phạm vi trang",
        description:
          "Nhập số trang hoặc phạm vi bạn muốn trích xuất (ví dụ: 1-5, 8, 10-15).",
      },
      {
        step: 4,
        title: "Tách và tải xuống",
        description:
          "Nhấp Tách để tạo tệp PDF mới của bạn và tải xuống chúng riêng lẻ hoặc dưới dạng kho lưu trữ ZIP.",
      },
    ],
    useCases: [
      {
        ...
        description:
          "Tách một cuốn sách hoặc hướng dẫn thành các chương riêng để đọc hoặc phân phối dễ dàng hơn.",
        icon: "book",
      },
      {
        title: "Tách quét kết hợp",
        description:
          "Chia tài liệu quét hàng loạt thành tệp riêng cho mỗi tài liệu gốc.",
        icon: "copy",
      },
      {
        title: "Tạo tài liệu phân phát",
        description:
          "Trích xuất trang trình bày hoặc trang cụ thể để tạo tài liệu phân phát tập trung.",
        icon: "presentation",
      },
    ],
    faq: [
      {
        ...
        answer:
          'Có, bạn có thể tách PDF thành tệp trang đơn bằng cách chọn tùy chọn "Tách mỗi trang".',
      },
      {
        question: "Điều gì xảy ra với đánh dấu trang khi tách?",
        answer:
          "Đánh dấu trang rơi trong phạm vi trang được trích xuất được bảo toàn trong tệp PDF kết quả.",
      },
      {
        question: "Tôi có thể tách PDF được bảo vệ bằng mật khẩu không?",
        answer:
          "Bạn cần giải mã PDF trước bằng công cụ Giải mã PDF của chúng tôi.",
      },
    ],
  },
  "compress-pdf": {
    title: "Nén PDF",
    metaDescription:
      "Giảm kích thước tệp PDF trong khi duy trì chất lượng. Công cụ nén PDF trực tuyến miễn phí cho tệp nhỏ hơn.",
    keywords: [
      "nén pdf",
      "giảm kích thước pdf",
      "công cụ nén pdf",
    ...
    howToUse: [
      {
        ...
        title: "Tải lên PDF của bạn",
        description:
          "Kéo và thả tệp PDF của bạn hoặc nhấp để chọn tài liệu bạn muốn nén.",
      },
      {
        step: 2,
        title: "Chọn mức nén",
        description:
          "Chọn mức nén ưa thích của bạn: Thấp (chất lượng tốt nhất), Trung bình (cân bằng) hoặc Cao (kích thước nhỏ nhất).",
      },
      {
        step: 3,
        title: "Nén và tải xuống",
        description:
          "Nhấp Nén để giảm kích thước tệp, sau đó tải xuống PDF đã tối ưu hóa của bạn.",
      },
    ],
    useCases: [
      {
        ...
        description:
          "Giảm kích thước PDF để đáp ứng giới hạn tệp đính kèm email và đảm bảo giao hàng nhanh hơn.",
        icon: "mail",
      },
      {
        title: "Xuất bản web",
        description:
          "Tối ưu hóa PDF cho tải xuống web để cải thiện tốc độ tải trang và trải nghiệm người dùng.",
        icon: "globe",
      },
      {
        title: "Tối ưu hóa lưu trữ",
        description:
          "Nén tài liệu lưu trữ để tiết kiệm dung lượng đĩa trong khi vẫn duy trì khả năng truy cập.",
        icon: "hard-drive",
      },
    ],
    faq: [
      {
        ...
        answer:
          "Kết quả nén thay đổi dựa trên nội dung PDF. PDF nặng hình ảnh có thể giảm 50-80%, trong khi PDF chỉ văn bản có thể giảm ít hơn.",
      },
      {
        question: "Nén có ảnh hưởng đến chất lượng văn bản không?",
        answer:
          "Văn bản vẫn sắc nét và có thể đọc được ở tất cả mức nén. Chỉ hình ảnh và đồ họa bị ảnh hưởng bởi nén.",
      },
      {
  ...
  "edit-pdf": {
    title: "Chỉnh sửa PDF",
    metaDescription:
      "Chỉnh sửa tệp PDF trực tuyến. Thêm văn bản, hình ảnh, chú thích, đánh dấu và hình dạng vào tài liệu của bạn.",
    keywords: [
      "chỉnh sửa pdf",
      "trình chỉnh sửa pdf",
      "chú thích pdf",
    ...
    howToUse: [
      {
        ...
        title: "Tải lên PDF của bạn",
        description:
          "Kéo và thả tệp PDF của bạn hoặc nhấp để chọn tài liệu bạn muốn chỉnh sửa.",
      },
      {
        step: 2,
        title: "Chọn công cụ chỉnh sửa",
        description:
          "Chọn từ thanh công cụ: văn bản, đánh dấu, hình dạng, hình ảnh, nhận xét hoặc công cụ xóa.",
      },
      {
        step: 3,
        title: "Thực hiện chỉnh sửa của bạn",
        description:
          "Nhấp vào tài liệu để thêm chú thích, kéo để định vị phần tử và sử dụng bảng thuộc tính để tùy chỉnh.",
      },
      {
        step: 4,
        title: "Lưu và tải xuống",
        description:
          "Nhấp Lưu để áp dụng thay đổi của bạn và tải xuống PDF đã chỉnh sửa.",
      },
    ],
    useCases: [
      {
        ...
        description:
          "Thêm nhận xét, đánh dấu và đánh dấu vào tài liệu để xem xét cộng tác.",
        icon: "message-square",
      },
      {
        title: "Điền biểu mẫu",
        description:
          "Điền văn bản, thêm chữ ký và hoàn thành biểu mẫu PDF mà không cần in ấn.",
        icon: "edit-3",
      },
      {
        title: "Xóa nội dung",
        description:
          "Loại bỏ vĩnh viễn thông tin nhạy cảm khỏi tài liệu trước khi chia sẻ.",
        icon: "eye-off",
      },
    ],
    faq: [
      {
        ...
        answer:
          "Công cụ này tập trung vào việc thêm chú thích và nội dung mới. Để chỉnh sửa văn bản hiện có, bạn có thể cần sử dụng tài liệu nguồn gốc.",
      },
      {
        question: "Chỉnh sửa của tôi có vĩnh viễn không?",
        answer:
          "Chú thích có thể được làm phẳng để vĩnh viễn, hoặc được giữ dưới dạng lớp có thể chỉnh sửa tùy thuộc vào sở thích của bạn.",
      },
      {
        question: "Tôi có thể hoàn tác thay đổi của mình không?",
        answer:
          "Có, trình chỉnh sửa hỗ trợ hoàn tác/làm lại. Bạn cũng có thể đặt lại về tài liệu gốc bất kỳ lúc nào trước khi lưu.",
      },
    ],
  },
  "jpg-to-pdf": {
    title: "JPG sang PDF",
    metaDescription:
      "Chuyển đổi hình ảnh JPG sang PDF. Kết hợp nhiều tệp JPG thành một tài liệu PDF duy nhất.",
    keywords: [
      "jpg sang pdf",
      "jpeg sang pdf",
      "chuyển đổi jpg",
    ...
    howToUse: [
      {
        ...
        description:
          "Kéo và thả tệp JPG của bạn hoặc nhấp để chọn hình ảnh từ thiết bị của bạn.",
      },
      {
        step: 2,
        title: "Sắp xếp và định cấu hình",
        description:
          "Sắp xếp lại hình ảnh bằng cách kéo, và chọn tùy chọn kích thước trang và định hướng.",
      },
      {
        step: 3,
    ...
    useCases: [
      {
        title: "Album ảnh",
        description:
          "Tạo album PDF từ ảnh kỳ nghỉ hoặc ảnh sự kiện để chia sẻ dễ dàng.",
        icon: "image",
      },
      {
        title: "Quét tài liệu",
        description:
          "Chuyển đổi ảnh máy ảnh điện thoại của tài liệu thành tệp PDF thích hợp.",
        icon: "camera",
      },
      {
        title: "Tạo danh mục đầu tư",
        description:
          "Sắp xếp công việc nhiếp ảnh hoặc mẫu thiết kế thành danh mục PDF chuyên nghiệp.",
        icon: "folder",
      },
    ],
    faq: [
      {
        ...
        answer:
          "Bạn có thể chuyển đổi tối đa 100 hình ảnh JPG thành một tài liệu PDF duy nhất.",
      },
      {
        question: "Chất lượng hình ảnh có được bảo toàn không?",
        answer:
          "Có, hình ảnh được nhúng ở chất lượng gốc của chúng. Bạn có thể tùy chọn nén chúng để giảm kích thước tệp.",
      },
      {
        question:
          "Tôi có thể đặt kích thước trang khác nhau cho hình ảnh khác nhau không?",
        answer:
          "Công cụ áp dụng kích thước trang thống nhất cho tất cả trang. Mỗi hình ảnh được chia tỷ lệ để vừa với kích thước trang đã chọn trong khi duy trì tỷ lệ khung hình.",
      },
    ],
  },
  "sign-pdf": {
    title: "Ký PDF",
    metaDescription:
      "Thêm chữ ký điện tử vào tài liệu PDF. Vẽ, nhập hoặc tải lên chữ ký của bạn.",
    ...
    howToUse: [
      {
        ...
        title: "Tải lên PDF của bạn",
        description:
          "Kéo và thả tệp PDF của bạn hoặc nhấp để chọn tài liệu bạn cần ký.",
      },
      {
        step: 2,
        title: "Tạo chữ ký của bạn",
        description:
          "Vẽ chữ ký của bạn bằng chuột hoặc chạm, nhập tên của bạn để tạo chữ ký hoặc tải lên hình ảnh chữ ký.",
      },
      {
        step: 3,
        title: "Đặt và điều chỉnh",
        description:
          "Nhấp vào tài liệu để đặt chữ ký của bạn, sau đó kéo để định vị và thay đổi kích thước nếu cần.",
      },
      {
        step: 4,
        title: "Lưu và tải xuống",
        description:
          "Nhấp Lưu để áp dụng chữ ký của bạn và tải xuống PDF đã ký.",
      },
    ],
    useCases: [
      {
        title: "Ký hợp đồng",
        description:
          "Ký hợp đồng và thỏa thuận điện tử mà không cần in và quét.",
        icon: "file-signature",
      },
      {
        title: "Điền biểu mẫu",
        description:
          "Thêm chữ ký của bạn vào biểu mẫu ứng dụng, biểu mẫu đồng ý và tài liệu chính thức.",
        icon: "clipboard",
      },
      {
    ...
    faq: [
      {
        ...
        answer:
          "Chữ ký điện tử được công nhận pháp lý ở hầu hết các quốc gia. Tuy nhiên, một số tài liệu có thể yêu cầu loại chữ ký số cụ thể. Kiểm tra quy định địa phương của bạn.",
      },
      {
        question:
          "Tôi có thể lưu chữ ký của mình để sử dụng trong tương lai không?",
        answer:
          "Có, bạn có thể lưu chữ ký của mình vào bộ nhớ cục bộ của trình duyệt để truy cập nhanh khi ký tài liệu trong tương lai.",
      },
      {
        question: "Tôi có thể thêm nhiều chữ ký vào một tài liệu không?",
        answer:
          "Có, bạn có thể thêm bao nhiêu chữ ký tùy thích, định vị từng chữ ký một cách độc lập trên bất kỳ trang nào.",
      },
    ],
  },
  "crop-pdf": {
    title: "Cắt PDF",
    metaDescription:
      "Cắt trang PDF để loại bỏ lề và khu vực không mong muốn. Cắt tài liệu PDF một cách chính xác.",
    keywords: [
      "cắt pdf",
      "cắt tỉa pdf",
      "cắt lề pdf",
    ...
    howToUse: [
      {
        ...
        title: "Tải lên PDF của bạn",
        description:
          "Kéo và thả tệp PDF của bạn hoặc nhấp để chọn tài liệu bạn muốn cắt.",
      },
      {
        step: 2,
        title: "Xác định khu vực cắt",
        description:
          "Kéo tay cầm cắt để xác định khu vực bạn muốn giữ, hoặc nhập số đo chính xác.",
      },
      {
        step: 3,
        title: "Áp dụng cho trang",
        description:
          "Chọn áp dụng cắt cho tất cả trang hoặc chọn trang cụ thể để cắt.",
      },
      {
        step: 4,
        title: "Cắt và tải xuống",
        description:
          "Nhấp Cắt để áp dụng thay đổi và tải xuống PDF đã cắt của bạn.",
      },
    ],
    useCases: [
      {
        title: "Loại bỏ lề",
        description:
          "Cắt tỉa lề dư thừa từ tài liệu đã quét hoặc PDF có đường viền lớn.",
        icon: "maximize-2",
      },
      {
        title: "Tập trung nội dung",
        description:
          "Cắt để làm nổi bật khu vực nội dung cụ thể, loại bỏ tiêu đề, chân trang hoặc thanh bên.",
        icon: "target",
      },
      {
        title: "Chuẩn hóa trang",
        description:
          "Làm cho tất cả trang có cùng kích thước bằng cách cắt theo kích thước thống nhất.",
        icon: "square",
      },
    ],
    faq: [
      {
        ...
        answer:
          "Có, cắt loại bỏ nội dung bên ngoài khu vực cắt. Đảm bảo giữ bản sao của tệp gốc của bạn.",
      },
      {
        question: "Tôi có thể cắt các trang khác nhau khác nhau không?",
        answer:
          "Có, bạn có thể áp dụng cài đặt cắt khác nhau cho từng trang hoặc nhóm trang.",
      },
      {
        question: "Cắt có ảnh hưởng đến chất lượng văn bản không?",
        answer:
          "Không, cắt chỉ loại bỏ khu vực bên ngoài ranh giới cắt. Nội dung còn lại duy trì chất lượng gốc.",
      },
    ],
  },
  "extract-pages": {
    ...
    metaDescription:
      "Trích xuất trang cụ thể từ tệp PDF. Chọn và lưu trang riêng lẻ dưới dạng tài liệu mới.",
    keywords: [
    ...
    howToUse: [
      {
        ...
        title: "Tải lên PDF của bạn",
        description:
          "Kéo và thả tệp PDF của bạn hoặc nhấp để chọn tài liệu bạn muốn trích xuất trang từ đó.",
      },
      {
        step: 2,
        title: "Chọn trang",
        description:
          "Nhấp vào hình thu nhỏ trang để chọn chúng, hoặc nhập số trang trong trường nhập liệu.",
      },
      {
        step: 3,
        title: "Trích xuất và tải xuống",
        description:
          "Nhấp Trích xuất để tạo PDF mới với các trang đã chọn của bạn và tải xuống.",
      },
    ],
    useCases: [
      {
        ...
        description:
          "Trích xuất trang liên quan từ báo cáo hoặc sách để tạo tài liệu tham khảo tập trung.",
        icon: "file-minus",
      },
      {
        title: "Chia sẻ nội dung cụ thể",
        description:
          "Kéo ra trang cụ thể để chia sẻ mà không gửi toàn bộ tài liệu.",
        icon: "share-2",
      },
      {
        title: "Lưu trữ trang quan trọng",
        description:
          "Trích xuất và lưu trang chính từ tài liệu để lưu trữ lâu dài.",
        icon: "archive",
      },
    ],
    faq: [
      {
        ...
        answer:
          "Có, bạn có thể chọn bất kỳ kết hợp trang nào, cho dù liên tiếp hay rải rác trong tài liệu.",
      },
      {
        question: "Đánh dấu trang có được bảo toàn không?",
        answer:
          "Đánh dấu trang trỏ đến trang được trích xuất được bảo toàn trong tài liệu PDF mới.",
      },
      {
        question: "Tôi có thể trích xuất từ nhiều PDF không?",
        answer:
          "Công cụ này hoạt động với một PDF tại một thời điểm. Để kết hợp trang từ nhiều PDF, hãy sử dụng công cụ Hợp nhất PDF trước.",
      },
    ],
  },
  "organize-pdf": {
    title: "Tổ chức PDF",
    metaDescription:
      "Sắp xếp lại, sao chép và xóa trang PDF. Kéo và thả để tổ chức tài liệu của bạn.",
    keywords: [
      "tổ chức pdf",
    ...
    howToUse: [
      {
        ...
        title: "Tải lên PDF của bạn",
        description:
          "Kéo và thả tệp PDF của bạn hoặc nhấp để chọn tài liệu bạn muốn tổ chức.",
      },
      {
        step: 2,
        title: "Sắp xếp lại trang",
        description:
          "Kéo hình thu nhỏ trang để sắp xếp lại chúng. Nhấp vào nút sao chép hoặc xóa trên mỗi trang nếu cần.",
      },
      {
        step: 3,
        title: "Lưu và tải xuống",
        description:
          "Nhấp Lưu để áp dụng thay đổi của bạn và tải xuống PDF đã tổ chức lại.",
      },
    ],
    useCases: [
      {
      ...
      },
      {
        ...
        description:
          "Sắp xếp trang theo thứ tự cụ thể cho bản trình bày hoặc báo cáo.",
        icon: "list",
      },
      {
        title: "Loại bỏ trang không mong muốn",
        description:
          "Xóa trang trống, bản sao hoặc nội dung không liên quan khỏi tài liệu.",
        icon: "trash-2",
      },
    ],
    faq: [
      {
        ...
        answer:
          "Có, bạn có thể sao chép bất kỳ trang nào và đặt bản sao ở bất kỳ đâu trong tài liệu.",
      },
      {
        question: "Có chức năng hoàn tác không?",
        answer:
          "Có, bạn có thể hoàn tác và làm lại thay đổi. Bạn cũng có thể đặt lại về thứ tự gốc bất kỳ lúc nào.",
      },
      {
        question: "Tôi có thể tổ chức nhiều PDF cùng nhau không?",
        answer:
          "Công cụ này hoạt động với một PDF tại một thời điểm. Để kết hợp và tổ chức nhiều PDF, hãy hợp nhất chúng bằng công cụ Hợp nhất PDF trước.",
      },
    ],
  },
  "delete-pages": {
    title: "Xóa trang",
    metaDescription:
      "Loại bỏ trang không mong muốn khỏi tệp PDF. Chọn và xóa trang cụ thể dễ dàng.",
    keywords: [
      "xóa trang pdf",
      "loại bỏ trang pdf",
    ...
    howToUse: [
      {
        ...
        title: "Tải lên PDF của bạn",
        description:
          "Kéo và thả tệp PDF của bạn hoặc nhấp để chọn tài liệu bạn muốn xóa trang từ đó.",
      },
      {
        step: 2,
        title: "Chọn trang để xóa",
        description:
          "Nhấp vào hình thu nhỏ trang để đánh dấu chúng để xóa, hoặc nhập số trang trong trường nhập liệu.",
      },
      {
        step: 3,
        title: "Xóa và tải xuống",
        description:
          "Nhấp Xóa để loại bỏ trang đã chọn và tải xuống PDF đã cập nhật của bạn.",
      },
    ],
    useCases: [
      {
        ...
        description:
          "Dọn dẹp tài liệu bằng cách loại bỏ trang trống được bao gồm một cách tình cờ.",
        icon: "file-x",
      },
      {
        title: "Loại bỏ nội dung nhạy cảm",
        description:
          "Xóa trang chứa thông tin bí mật trước khi chia sẻ tài liệu.",
        icon: "shield",
      },
      {
        title: "Hợp lý hóa tài liệu",
        description:
          "Loại bỏ trang lỗi thời hoặc không liên quan để tạo tài liệu tập trung hơn.",
        icon: "filter",
      },
    ],
    faq: [
      {
        ...
        answer:
          "Xóa là vĩnh viễn trong tệp đầu ra. Giữ bản sao của tài liệu gốc của bạn nếu bạn có thể cần trang sau này.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Đánh dấu trang trỏ đến trang đã xóa sẽ bị xóa. Đánh dấu trang đến trang còn lại được bảo toàn.",
      },
    ],
  },
  bookmark: {
    ...
    metaDescription:
      "Thêm, chỉnh sửa và quản lý đánh dấu trang PDF. Tạo cấu trúc điều hướng cho tài liệu của bạn.",
    keywords: [
      "đánh dấu trang pdf",
    ...
    howToUse: [
      ...
      },
      {
        ...
        description:
          "Thêm đánh dấu trang mới, chỉnh sửa đánh dấu trang hiện có hoặc kéo để tổ chức lại cấu trúc phân cấp.",
      },
      {
        step: 3,
        title: "Lưu và tải xuống",
        description:
          "Nhấp Lưu để áp dụng thay đổi của bạn và tải xuống PDF với đánh dấu trang đã cập nhật.",
      },
    ],
    useCases: [
      {
        ...
        description:
          "Thêm đánh dấu trang vào tài liệu dài để giúp người đọc điều hướng nhanh đến các phần cụ thể.",
        icon: "navigation",
      },
      {
        title: "Tổ chức chương",
        description:
          "Tạo cấu trúc đánh dấu trang phân cấp phản ánh tổ chức chương của tài liệu của bạn.",
        icon: "book-open",
      },
      {
        title: "Cải thiện khả năng truy cập",
        description:
          "Thêm đánh dấu trang để làm cho tài liệu dễ truy cập và thân thiện với người dùng hơn.",
        icon: "accessibility",
      },
    ],
    faq: [
      {
        ...
        answer:
          "Có, bạn có thể tạo cấu trúc phân cấp với đánh dấu trang cha và con.",
      },
      {
        question: "Tôi có thể nhập đánh dấu trang từ tệp không?",
        answer:
          "Có, bạn có thể nhập cấu trúc đánh dấu trang từ tệp JSON hoặc văn bản.",
      },
      {
        question:
          "Đánh dấu trang có hoạt động trong tất cả trình đọc PDF không?",
        answer:
          "Có, đánh dấu trang là tính năng PDF tiêu chuẩn được hỗ trợ bởi tất cả trình đọc PDF chính.",
      },
    ],
  },
  "table-of-contents": {
    title: "Mục lục",
    metaDescription:
      "Tạo mục lục cho PDF của bạn. Tạo điều hướng có thể nhấp từ đánh dấu trang.",
    keywords: [
      "mục lục pdf",
      "trình tạo toc",
      "chỉ mục pdf",
    ...
    howToUse: [
      ...
      },
      {
        ...
        description:
          "Chọn tạo từ đánh dấu trang hoặc tạo mục nhập tùy chỉnh. Chọn tùy chọn kiểu dáng và định vị.",
      },
      {
        step: 3,
        title: "Tạo và tải xuống",
        description:
          "Nhấp Tạo để tạo mục lục và tải xuống PDF đã cập nhật của bạn.",
      },
    ],
    useCases: [
      {
        ...
        description:
          "Thêm mục lục chuyên nghiệp vào luận án, luận văn và bài nghiên cứu.",
        icon: "graduation-cap",
      },
      {
        title: "Báo cáo kinh doanh",
        description:
          "Tạo báo cáo có thể điều hướng với danh sách phần rõ ràng cho các bên liên quan.",
        icon: "bar-chart",
      },
      {
        title: "Hướng dẫn sử dụng",
        description:
          "Tạo TOC toàn diện cho tài liệu kỹ thuật và hướng dẫn sử dụng.",
        icon: "book",
      },
    ],
    faq: [
      {
        ...
        answer:
          "Có, bạn có thể chọn từ các kiểu dáng, phông chữ và bố cục khác nhau cho mục lục của mình.",
      },
      {
        question: "TOC được chèn ở đâu?",
        answer:
          "Theo mặc định, TOC được chèn ở đầu tài liệu, nhưng bạn có thể chọn vị trí khác.",
      },
      {
        question: "Các mục nhập TOC có thể nhấp không?",
        answer:
          "Có, mỗi mục nhập là liên kết có thể nhấp điều hướng đến trang tương ứng.",
      },
    ],
  },
  "page-numbers": {
    title: "Số trang",
    metaDescription:
      "Thêm số trang vào tài liệu PDF. Tùy chỉnh vị trí, định dạng và số bắt đầu.",
    keywords: [
      "thêm số trang",
      "số trang pdf",
      "đánh số trang pdf",
    ...
    howToUse: [
      ...
      },
      {
        ...
        description:
          "Chọn vị trí, định dạng, số bắt đầu và trang nào để đánh số.",
      },
      {
        step: 3,
        title: "Áp dụng và tải xuống",
        description:
          "Nhấp Áp dụng để thêm số trang và tải xuống PDF đã cập nhật của bạn.",
      },
    ],
    useCases: [
      {
        ...
        description:
          "Thêm số trang vào báo cáo, đề xuất và tài liệu kinh doanh.",
        icon: "file-text",
      },
      {
        title: "Bài báo học thuật",
    ...
    faq: [
      {
        ...
        answer:
          "Có, bạn có thể chỉ định trang nào có số trang và trang nào được bỏ qua, chẳng hạn như trang tiêu đề hoặc trang bìa.",
      },
      {
        question: "Định dạng số nào có sẵn?",
        answer:
          "Bạn có thể sử dụng chữ số Ả Rập (1, 2, 3), chữ số La Mã (i, ii, iii hoặc I, II, III) hoặc chữ cái (a, b, c).",
      },
      {
        question: 'Tôi có thể thêm định dạng "Trang X của Y" không?',
        answer:
          "Có, bạn có thể bao gồm số trang tổng trong định dạng đánh số của mình.",
      },
    ],
  },
  "add-watermark": {
    title: "Thêm hình mờ",
    metaDescription:
      "Thêm hình mờ văn bản hoặc hình ảnh vào tệp PDF. Bảo vệ và thương hiệu tài liệu của bạn.",
    keywords: [
      "thêm hình mờ",
      "hình mờ pdf",
      "đóng dấu pdf",
    ...
    howToUse: [
      ...
      },
      {
        ...
        title: "Tạo hình mờ",
        description:
          "Nhập văn bản hoặc tải lên hình ảnh cho hình mờ của bạn. Điều chỉnh vị trí, kích thước, độ trong suốt và xoay.",
      },
      {
        step: 3,
        title: "Áp dụng và tải xuống",
        description:
          "Nhấp Áp dụng để thêm hình mờ và tải xuống PDF đã cập nhật của bạn.",
      },
    ],
    useCases: [
      {
        ...
        description:
          'Thêm hình mờ "Bí mật" hoặc "Bản nháp" để chỉ ra trạng thái tài liệu.',
        icon: "shield",
      },
      {
    ...
    faq: [
      {
        ...
        answer:
          "Có, bạn có thể tải lên hình ảnh PNG, JPG hoặc SVG để sử dụng làm hình mờ.",
      },
      {
        question: "Tôi có thể làm cho hình mờ bán trong suốt không?",
        answer:
          "Có, bạn có thể điều chỉnh độ trong suốt từ hoàn toàn trong suốt đến hoàn toàn mờ.",
      },
      {
        question:
          "Tôi có thể áp dụng hình mờ khác nhau cho các trang khác nhau không?",
        answer:
          "Công cụ áp dụng cùng một hình mờ cho các trang đã chọn. Để có hình mờ khác nhau, hãy xử lý tài liệu nhiều lần.",
      },
    ],
  },
  "header-footer": {
    ...
    metaDescription:
      "Thêm tiêu đề và chân trang vào tài liệu PDF. Bao gồm số trang, ngày tháng và văn bản tùy chỉnh.",
    keywords: [
      "tiêu đề pdf",
      "chân trang pdf",
    ...
    howToUse: [
      ...
      },
      {
        ...
        description:
          "Nhập văn bản cho khu vực tiêu đề và chân trang. Thêm số trang, ngày tháng hoặc văn bản tùy chỉnh.",
      },
      {
        step: 3,
        title: "Áp dụng và tải xuống",
        description:
          "Nhấp Áp dụng để thêm tiêu đề/chân trang và tải xuống PDF đã cập nhật của bạn.",
      },
    ],
    useCases: [
      {
      ...
      },
      {
        title: "Tài liệu pháp lý",
        description:
          "Bao gồm số trường hợp, ngày tháng và tham chiếu trang trong hồ sơ tòa án.",
        icon: "scale",
      },
      {
        title: "Bài báo học thuật",
    ...
    faq: [
      {
        question:
          "Tôi có thể có tiêu đề khác nhau trên trang lẻ và chẵn không?",
        answer:
          "Có, bạn có thể định cấu hình nội dung khác nhau cho trang lẻ và chẵn.",
      },
      {
      ...
      {
        question:
          "Tôi có thể bỏ qua tiêu đề/chân trang trên các trang nhất định không?",
        answer:
          "Có, bạn có thể chỉ định trang nào có tiêu đề/chân trang và trang nào được bỏ qua.",
      },
    ],
  },
  "invert-colors": {
    ...
    metaDescription:
      "Đảo ngược màu sắc PDF để đọc chế độ tối. Chuyển đổi tài liệu thành màu âm.",
    keywords: [
    ...
    useCases: [
      {
        title: "Đọc ban đêm",
        description:
          "Tạo phiên bản chế độ tối của tài liệu để đọc thoải mái vào ban đêm.",
        icon: "moon",
      },
      {
        title: "Giảm mỏi mắt",
        description:
          "Đảo ngược tài liệu sáng để giảm mỏi mắt trong khi đọc kéo dài.",
        icon: "eye",
      },
      {
        title: "Tiết kiệm in ấn",
        description:
          "Đảo ngược tài liệu để giảm mức sử dụng mực khi in bản nháp.",
        icon: "printer",
      },
    ],
    faq: [
      {
        ...
        answer:
          "Theo mặc định, có. Bạn có thể chọn bảo toàn hình ảnh gốc trong khi đảo ngược văn bản và nền.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Bạn có thể đảo ngược tài liệu lại để trở về màu sắc gần như gốc.",
      },
    ],
  },
  "background-color": {
    ...
    howToUse: [
      ...
      },
      {
        ...
        title: "Áp dụng và tải xuống",
        description:
          "Nhấp Áp dụng để thêm nền và tải xuống PDF đã cập nhật của bạn.",
      },
    ],
    useCases: [
      {
    ...
    faq: [
      {
        ...
        answer:
          "Không, nền được thêm phía sau nội dung hiện có, bảo toàn tất cả văn bản và hình ảnh.",
      },
      {
        question:
          "Tôi có thể sử dụng màu khác nhau cho các trang khác nhau không?",
        answer:
          "Bạn sẽ cần xử lý tài liệu nhiều lần cho màu khác nhau trên các trang khác nhau.",
      },
      {
        question: "Tôi có thể xóa nền hiện có không?",
        answer:
          "Công cụ này thêm nền. Để xóa nền, bạn có thể cần sử dụng công cụ Chỉnh sửa PDF.",
      },
    ],
  },
  "text-color": {
    ...
    metaDescription:
      "Thay đổi màu văn bản trong tài liệu PDF. Sửa đổi màu của tất cả nội dung văn bản.",
    keywords: [
    ...
    howToUse: [
      ...
      },
      {
        ...
        title: "Áp dụng và tải xuống",
        description:
          "Nhấp Áp dụng để thay đổi màu văn bản và tải xuống PDF đã cập nhật của bạn.",
      },
    ],
    useCases: [
      {
        title: "Cải thiện độ tương phản",
        description:
          "Thay đổi màu văn bản để cải thiện khả năng đọc so với nền.",
        icon: "contrast",
      },
      {
        title: "Nhất quán thương hiệu",
        description:
          "Cập nhật màu văn bản để phù hợp với hướng dẫn thương hiệu.",
        icon: "palette",
      },
      {
        title: "Khả năng truy cập",
        description:
          "Điều chỉnh màu văn bản để đáp ứng yêu cầu độ tương phản về khả năng truy cập.",
        icon: "accessibility",
      },
    ],
    faq: [
      {
        ...
        answer:
          "Có, công cụ thay đổi màu của tất cả phần tử văn bản trong tài liệu.",
      },
      {
        question: "Tôi có thể thay đổi chỉ văn bản cụ thể không?",
        answer:
          "Công cụ này thay đổi tất cả văn bản. Để thay đổi có chọn lọc, hãy sử dụng công cụ Chỉnh sửa PDF.",
      },
      {
  ...
  "add-stamps": {
    title: "Thêm dấu",
    metaDescription:
      "Thêm dấu vào tài liệu PDF. Sử dụng dấu đặt sẵn hoặc tùy chỉnh cho phê duyệt, xem xét và hơn thế nữa.",
    ...
    howToUse: [
      ...
      },
      {
        ...
        description:
          "Nhấp để đặt dấu, điều chỉnh vị trí và kích thước, sau đó tải xuống.",
      },
    ],
    useCases: [
      {
        ...
        description:
          'Thêm dấu "Đã phê duyệt" hoặc "Từ chối" vào tài liệu trong quy trình xem xét.',
        icon: "check-circle",
      },
      {
        title: "Chỉ báo trạng thái",
        description:
          'Đánh dấu tài liệu là "Bản nháp", "Cuối cùng" hoặc "Bí mật".',
        icon: "tag",
      },
      {
    ...
    faq: [
      {
        ...
        answer:
          "Đặt sẵn bao gồm Đã phê duyệt, Từ chối, Bản nháp, Cuối cùng, Bí mật, Sao chép và nhiều hơn nữa.",
      },
      {
        question: "Tôi có thể tải lên dấu tùy chỉnh không?",
        answer:
          "Có, bạn có thể tải lên hình ảnh PNG hoặc JPG để sử dụng làm dấu tùy chỉnh.",
      },
      {
        question: "Tôi có thể thêm nhiều dấu vào một tài liệu không?",
        answer:
          "Có, bạn có thể thêm nhiều dấu và định vị từng dấu một cách độc lập.",
      },
    ],
  },
  "remove-annotations": {
    ...
    metaDescription:
      "Loại bỏ chú thích khỏi tệp PDF. Xóa nhận xét, đánh dấu và đánh dấu.",
    keywords: [
    ...
    howToUse: [
      ...
      },
      {
        ...
        description:
          "Chọn loại chú thích nào để loại bỏ: nhận xét, đánh dấu, liên kết, v.v.",
      },
      {
        step: 3,
    ...
    useCases: [
      {
        ...
        description:
          "Loại bỏ nhận xét xem xét và đánh dấu trước khi xuất bản tài liệu cuối cùng.",
        icon: "file-check",
      },
      {
        title: "Bảo vệ quyền riêng tư",
        description:
          "Loại bỏ nhận xét có thể chứa thông tin nhạy cảm trước khi chia sẻ.",
        icon: "shield",
      },
      {
    ...
    faq: [
      {
        ...
        answer:
          "Nhận xét, đánh dấu, gạch dưới, gạch ngang, ghi chú dính, dấu và liên kết đều có thể loại bỏ.",
      },
      {
        question: "Tôi có thể giữ một số chú thích không?",
        answer:
          "Có, bạn có thể chọn loại chú thích nào để loại bỏ và loại nào để giữ.",
      },
      {
        question: "Điều này có thể đảo ngược không?",
        answer:
          "Không, việc loại bỏ chú thích là vĩnh viễn. Giữ bản sao của bản gốc nếu cần.",
      },
    ],
  },
  "form-filler": {
    title: "Điền biểu mẫu",
    metaDescription:
      "Điền biểu mẫu PDF trực tuyến. Hoàn thành biểu mẫu PDF tương tác mà không cần in ấn.",
    keywords: [
      "điền biểu mẫu pdf",
    ...
    howToUse: [
      ...
      },
      {
        ...
        title: "Điền biểu mẫu",
        description:
          "Nhấp vào trường biểu mẫu để nhập văn bản, đánh dấu hộp kiểm hoặc chọn tùy chọn.",
      },
      {
        step: 3,
        title: "Lưu và tải xuống",
        description:
          "Nhấp Lưu để bảo toàn mục nhập của bạn và tải xuống biểu mẫu đã điền.",
      },
    ],
    useCases: [
      {
      ...
      },
      {
        title: "Hợp đồng",
        description:
          "Hoàn thành biểu mẫu hợp đồng với thông tin của bạn trước khi ký.",
        icon: "file-signature",
      },
    ],
    faq: [
      ...
      },
      {
        ...
        answer:
          "Làm phẳng chuyển đổi trường biểu mẫu thành nội dung tĩnh, ngăn chặn chỉnh sửa thêm.",
      },
      {
        question: "Biểu mẫu XFA có được hỗ trợ không?",
        answer:
          "Có, công cụ hỗ trợ cả biểu mẫu AcroForms tiêu chuẩn và biểu mẫu XFA.",
      },
    ],
  },
  "form-creator": {
    title: "Tạo biểu mẫu",
    metaDescription:
      "Tạo biểu mẫu PDF có thể điền. Thêm trường văn bản, hộp kiểm và menu thả xuống vào tài liệu.",
    keywords: [
      "tạo biểu mẫu pdf",
    ...
    howToUse: [
      {
        ...
        title: "Tải lên PDF của bạn",
        description:
          "Kéo và thả tệp PDF của bạn hoặc nhấp để chọn tài liệu để chuyển đổi thành biểu mẫu.",
      },
      {
        step: 2,
        title: "Thêm trường biểu mẫu",
        description:
          "Chọn loại trường từ thanh công cụ và nhấp để đặt chúng trên tài liệu.",
      },
      {
        step: 3,
        title: "Định cấu hình và lưu",
        description:
          "Đặt thuộc tính trường, sau đó lưu và tải xuống PDF biểu mẫu có thể điền của bạn.",
      },
    ],
    useCases: [
      {
        title: "Biểu mẫu ứng dụng",
        description:
          "Tạo đơn xin việc có thể điền, biểu mẫu thành viên và đăng ký.",
        icon: "user-plus",
      },
      {
        title: "Khảo sát",
        description:
          "Xây dựng khảo sát và bảng câu hỏi tương tác để thu thập dữ liệu.",
        icon: "clipboard-list",
      },
      {
        title: "Biểu mẫu đặt hàng",
        description:
          "Tạo biểu mẫu đặt hàng sản phẩm với trường số lượng và hộp kiểm.",
        icon: "shopping-cart",
      },
    ],
    faq: [
      {
        ...
        answer:
          "Trường văn bản, hộp kiểm, nút radio, menu thả xuống, bộ chọn ngày và trường chữ ký.",
      },
      {
        question: "Tôi có thể làm cho trường bắt buộc không?",
        answer:
          "Có, bạn có thể đánh dấu trường là bắt buộc và thêm quy tắc xác thực.",
      },
      {
        question: "Tôi có thể thêm tính toán không?",
        answer:
          "Tính toán cơ bản như tổng và trung bình có thể được thêm vào trường số.",
      },
    ],
  },
  "remove-blank-pages": {
    title: "Loại bỏ trang trống",
    metaDescription:
      "Tự động phát hiện và loại bỏ trang trống khỏi tài liệu PDF.",
    keywords: [
      "loại bỏ trang trống",
      "xóa trang trống",
      "dọn dẹp pdf",
    ...
    howToUse: [
      ...
      },
      {
        ...
        description:
          "Đặt ngưỡng phát hiện trống nếu cần (mặc định hoạt động cho hầu hết tài liệu).",
      },
      {
        step: 3,
        title: "Loại bỏ và tải xuống",
        description:
          "Nhấp Loại bỏ để xóa trang trống và tải xuống PDF đã dọn dẹp.",
      },
    ],
    useCases: [
      {
      ...
      },
      {
        ...
        description:
          "Loại bỏ trang trống không cần thiết để giảm kích thước tài liệu.",
        icon: "minimize-2",
      },
    ],
    faq: [
      {
        ...
        answer:
          "Công cụ phân tích nội dung trang và coi trang có nội dung tối thiểu hoặc không có nội dung hiển thị là trống.",
      },
      {
        question: "Tôi có thể xem trước trang nào sẽ bị loại bỏ không?",
        answer:
          "Có, trang trống được phát hiện được đánh dấu để xem xét trước khi loại bỏ.",
      },
      {
        question: "Điều gì nếu một trang chỉ có tiêu đề/chân trang?",
        answer:
          "Bạn có thể điều chỉnh ngưỡng để xác định xem trang có nội dung tối thiểu có được coi là trống không.",
      },
    ],
  },
  "image-to-pdf": {
    ...
    metaDescription:
      "Chuyển đổi bất kỳ hình ảnh nào sang PDF. Hỗ trợ định dạng JPG, PNG, WebP, BMP, TIFF, SVG và HEIC.",
    keywords: [
      "hình ảnh sang pdf",
      "chuyển đổi hình ảnh",
      "ảnh sang pdf",
    ...
    howToUse: [
      {
        ...
        description:
          "Kéo và thả hình ảnh của bất kỳ định dạng được hỗ trợ nào hoặc nhấp để chọn tệp.",
      },
      {
        step: 2,
        title: "Sắp xếp và định cấu hình",
    ...
    useCases: [
      {
        ...
        description:
          "Kết hợp ảnh từ nhiều nguồn khác nhau thành một album PDF duy nhất.",
        icon: "images",
      },
      {
        title: "Tài liệu định dạng hỗn hợp",
        description:
          "Chuyển đổi hình ảnh từ định dạng khác nhau thành PDF thống nhất.",
        icon: "file-stack",
      },
      {
        title: "Tạo lưu trữ",
        description:
          "Tạo lưu trữ PDF từ bộ sưu tập hình ảnh để lưu trữ lâu dài.",
        icon: "archive",
      },
    ],
    faq: [
      {
        ...
        answer:
          "Định dạng JPG, JPEG, PNG, WebP, BMP, TIFF, TIF, SVG, HEIC và HEIF đều được hỗ trợ.",
      },
      {
        question: "Tôi có thể trộn các định dạng hình ảnh khác nhau không?",
        answer:
          "Có, bạn có thể kết hợp hình ảnh của các định dạng khác nhau thành một PDF duy nhất.",
      },
      {
        question: "Chất lượng hình ảnh có được bảo toàn không?",
        answer:
          "Có, hình ảnh được nhúng ở chất lượng gốc của chúng trừ khi bạn chọn nén chúng để giảm kích thước tệp.",
      },
    ],
  },
  "png-to-pdf": {
    title: "PNG sang PDF",
    metaDescription:
      "Chuyển đổi hình ảnh PNG sang PDF. Bảo toàn độ trong suốt và kết hợp nhiều tệp PNG.",
    keywords: [
      "png sang pdf",
      "chuyển đổi png",
    ...
    useCases: [
      {
        ...
        description:
          "Sắp xếp đồ họa PNG và thiết kế thành danh mục chuyên nghiệp.",
        icon: "palette",
      },
      {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "PNG động được chuyển đổi dưới dạng hình ảnh tĩnh bằng khung đầu tiên.",
      },
      {
  ...
  "webp-to-pdf": {
    title: "WebP sang PDF",
    metaDescription:
      "Chuyển đổi hình ảnh WebP sang PDF. Chuyển đổi định dạng hình ảnh hiện đại với bảo toàn chất lượng.",
    keywords: [
      "webp sang pdf",
      "chuyển đổi webp",
    ...
    faq: [
      {
        ...
        answer:
          "WebP là định dạng hình ảnh được phát triển bởi Google cung cấp nén tốt hơn JPEG.",
      },
      {
  ...
  "svg-to-pdf": {
    title: "SVG sang PDF",
    metaDescription:
      "Chuyển đổi đồ họa vector SVG sang PDF. Bảo toàn khả năng mở rộng và chất lượng.",
    keywords: [
      "svg sang pdf",
      "chuyển đổi svg",
      "vector sang pdf",
    ...
    useCases: [
      ...
      },
      {
        title: "Bản vẽ kỹ thuật",
        description:
          "Chuyển đổi bản vẽ kỹ thuật và minh họa xuất CAD sang PDF.",
        icon: "ruler",
      },
      {
    ...
    faq: [
      {
        ...
        answer:
          "Có, chất lượng vector SVG được bảo toàn hoàn toàn trong đầu ra PDF.",
      },
      {
        question: "Tôi có thể chuyển đổi SVG phức tạp không?",
        answer:
          "Có, SVG phức tạp với gradient, bộ lọc và hiệu ứng được hỗ trợ.",
      },
      {
  ...
  "bmp-to-pdf": {
    title: "BMP sang PDF",
    metaDescription:
      "Chuyển đổi hình ảnh bitmap BMP sang PDF. Hỗ trợ định dạng kế thừa với bảo toàn chất lượng.",
    keywords: [
      "bmp sang pdf",
      "chuyển đổi bmp",
      "bitmap sang pdf",
    ...
    useCases: [
      ...
      },
      {
        ...
        description:
          "Cập nhật lưu trữ kế thừa sang định dạng PDF để tương thích tốt hơn.",
        icon: "archive",
      },
    ],
    faq: [
      ...
      },
      {
        question: "Chất lượng có được bảo toàn không?",
        answer:
          "Có, chất lượng hình ảnh được duy trì trong quá trình chuyển đổi.",
      },
      {
        question: "Độ sâu màu BMP nào được hỗ trợ?",
        answer:
          "Độ sâu màu tiêu chuẩn BMP, bao gồm 24-bit và 32-bit, được hỗ trợ.",
      },
    ],
  },
  "psd-to-pdf": {
    title: "PSD sang PDF",
    metaDescription:
      "Chuyển đổi tệp Adobe Photoshop (PSD) sang định dạng PDF. Hỗ trợ nhiều tệp và bảo toàn chất lượng hình ảnh.",
    keywords: [
      "psd sang pdf",
      "chuyển đổi psd",
      "photoshop sang pdf",
    ...
    howToUse: [
      {
        ...
        description:
          "Kéo và thả tệp PSD hoặc PSB của bạn, hoặc nhấp để chọn từ thiết bị của bạn.",
      },
      {
        step: 2,
        title: "Sắp xếp thứ tự",
      ...
      },
      {
        ...
        title: "Chuyển đổi và tải xuống",
        description:
          "Nhấp Chuyển đổi để kết xuất PSD và tải xuống tài liệu PDF của bạn.",
      },
    ],
    useCases: [
      {
        ...
        description:
          "Chia sẻ thiết kế Photoshop với khách hàng hoặc đồng nghiệp không có Photoshop.",
        icon: "share-2",
      },
      {
        title: "Tạo danh mục đầu tư",
        description:
          "Sắp xếp công việc thiết kế của bạn thành danh mục PDF chuyên nghiệp.",
        icon: "layout",
      },
      {
        title: "Chuẩn bị in ấn",
    ...
    faq: [
      {
        ...
        answer:
          "Không, công cụ này hoạt động hoàn toàn trong trình duyệt của bạn mà không yêu cầu Adobe Photoshop.",
      },
      {
        question: "Lớp có được bảo toàn không?",
        answer:
          "Công cụ kết xuất trạng thái hiển thị của PSD (hình ảnh tổng hợp). Các lớp riêng lẻ được làm phẳng trong PDF.",
      },
      {
        question: "Kích thước tệp tối đa là bao nhiêu?",
        answer:
          "Bạn có thể tải lên tệp lên đến 100MB mỗi tệp. Tệp PSD lớn có thể mất một chút thời gian để xử lý.",
      },
    ],
  },
  "heic-to-pdf": {
    title: "HEIC sang PDF",
    metaDescription:
      "Chuyển đổi ảnh iPhone HEIC sang PDF. Chuyển đổi định dạng hình ảnh Apple dễ dàng.",
    keywords: [
      "heic sang pdf",
      "chuyển đổi heic",
      "ảnh iPhone sang pdf",
    ...
    faq: [
      {
        ...
        answer:
          "HEIC (High Efficiency Image Container) là định dạng hình ảnh của Apple cung cấp nén tốt hơn JPEG.",
      },
      {
        question: "Ảnh động có được hỗ trợ không?",
        answer:
          "Ảnh động được chuyển đổi dưới dạng hình ảnh tĩnh bằng khung chính.",
      },
      {
        question: "Dữ liệu EXIF có được bảo toàn không?",
        answer:
          "Siêu dữ liệu ảnh có thể được bảo toàn hoặc loại bỏ trong quá trình chuyển đổi.",
      },
    ],
  },
  "tiff-to-pdf": {
    title: "TIFF sang PDF",
    metaDescription:
      "Chuyển đổi hình ảnh TIFF sang PDF. Chất lượng chuyên nghiệp với hỗ trợ đa trang.",
    keywords: [
      "tiff sang pdf",
      "chuyển đổi tiff",
      "tif sang pdf",
    ...
    useCases: [
      ...
      },
      {
        ...
        description:
          "Chuyển đổi lưu trữ TIFF sang định dạng PDF dễ truy cập hơn.",
        icon: "archive",
      },
    ],
    faq: [
      {
        ...
        answer:
          "Có, tệp TIFF đa trang được chuyển đổi thành PDF đa trang tự động.",
      },
      {
        question: "Chất lượng có được bảo toàn không?",
  ...
  "txt-to-pdf": {
    ...
    metaDescription:
      "Chuyển đổi tệp văn bản thuần túy sang PDF. Tùy chỉnh phông chữ, lề và bố cục trang.",
    keywords: [
      "txt sang pdf",
      "văn bản sang pdf",
    ...
    useCases: [
      ...
      },
      {
        ...
        description:
          "Chuyển đổi ghi chú văn bản thuần túy sang tài liệu PDF được định dạng.",
        icon: "sticky-note",
      },
    ],
    faq: [
  ...
  "json-to-pdf": {
    title: "JSON sang PDF",
    metaDescription:
      "Chuyển đổi tệp JSON sang định dạng PDF. Làm nổi bật cú pháp và đầu ra có cấu trúc.",
    keywords: [
      "json sang pdf",
      "chuyển đổi json",
      "trình xem json",
    ...
    faq: [
      {
        ...
        answer:
          "Có, cú pháp JSON được làm nổi bật với màu sắc cho khóa, giá trị và kiểu.",
      },
      {
  ...
  "word-to-pdf": {
    title: "Word sang PDF",
    metaDescription:
      "Chuyển đổi tài liệu Word (DOCX) sang PDF. Bảo toàn định dạng và bố cục trong tài liệu đã chuyển đổi của bạn.",
    keywords: [
      "word sang pdf",
      "docx sang pdf",
      "chuyển đổi word",
    ...
    howToUse: [
      {
        ...
        description:
          "Kéo và thả tệp .docx của bạn hoặc nhấp để chọn từ thiết bị của bạn.",
      },
      {
        step: 2,
        title: "Chờ xử lý",
      ...
      },
      {
        ...
        title: "Tải xuống PDF",
        description:
          "Nhấp Tải xuống để lưu tài liệu PDF đã chuyển đổi của bạn.",
      },
    ],
    useCases: [
      {
        ...
        description:
          "Chuyển đổi tài liệu Word sang PDF để chia sẻ và xem phổ quát.",
        icon: "share-2",
      },
      {
        title: "Chuẩn bị in ấn",
      ...
      },
      {
        ...
        description:
          "Lưu trữ tài liệu Word ở định dạng PDF ổn định để lưu trữ lâu dài.",
        icon: "archive",
      },
    ],
    faq: [
      {
        ...
        answer:
          "Hiện tại chỉ định dạng .docx được hỗ trợ. Vui lòng chuyển đổi tệp .doc sang .docx trước bằng Microsoft Word hoặc LibreOffice.",
      },
      {
        question: "Hình ảnh có được bảo toàn không?",
        answer:
          "Nội dung văn bản và định dạng cơ bản được bảo toàn. Bố cục phức tạp với nhiều hình ảnh có thể có kết xuất đơn giản hóa.",
      },
      {
        question: "Việc chuyển đổi có an toàn không?",
        answer:
          "Có, tất cả xử lý diễn ra trong trình duyệt của bạn. Tài liệu của bạn không bao giờ được tải lên máy chủ nào.",
      },
    ],
  },
  "excel-to-pdf": {
    ...
    metaDescription:
      "Chuyển đổi bảng tính Excel (XLSX) sang PDF. Bảo toàn bảng và dữ liệu trong tài liệu đã chuyển đổi của bạn.",
    keywords: [
      "excel sang pdf",
      "xlsx sang pdf",
      "chuyển đổi excel",
    ...
    howToUse: [
      {
        ...
        description:
          "Kéo và thả tệp .xlsx của bạn hoặc nhấp để chọn từ thiết bị của bạn.",
      },
      {
        step: 2,
        title: "Chờ xử lý",
        description:
          "Công cụ sẽ tải bảng tính và chuyển đổi tất cả trang tính.",
      },
      {
        step: 3,
        title: "Tải xuống PDF",
    ...
    useCases: [
      {
        ...
        description:
          "Chuyển đổi báo cáo Excel sang PDF để phân phối cho các bên liên quan.",
        icon: "file-text",
      },
      {
    ...
    faq: [
      {
        ...
        answer:
          "Có, tất cả trang tính trong sổ làm việc được chuyển đổi và bao gồm trong PDF.",
      },
      {
        question: "Định dạng .xls có được hỗ trợ không?",
        answer:
          "Hiện tại chỉ định dạng .xlsx được hỗ trợ. Vui lòng lưu tệp .xls dưới dạng .xlsx trước.",
      },
      {
        question: "Công thức có được bảo toàn không?",
        answer:
          "PDF hiển thị giá trị được tính toán. Công thức không thể thực thi được trong định dạng PDF.",
      },
    ],
  },
  "pptx-to-pdf": {
    ...
    metaDescription:
      "Chuyển đổi bản trình bày PowerPoint (PPTX) sang PDF. Bảo toàn trang trình bày và nội dung để chia sẻ dễ dàng.",
    keywords: [
      "powerpoint sang pdf",
      "pptx sang pdf",
      "chuyển đổi pptx",
    ...
    howToUse: [
      {
        ...
        description:
          "Kéo và thả tệp .pptx của bạn hoặc nhấp để chọn từ thiết bị của bạn.",
      },
      {
        step: 2,
        title: "Chờ xử lý",
        description:
          "Công cụ sẽ trích xuất nội dung trang trình bày và tạo PDF.",
      },
      {
        step: 3,
        title: "Tải xuống PDF",
    ...
    useCases: [
      {
        ...
        description:
          "Chia sẻ bản trình bày với bất kỳ ai mà không yêu cầu PowerPoint.",
        icon: "share-2",
      },
      {
        title: "Tạo tài liệu phân phát",
    ...
    faq: [
      {
        ...
        answer:
          "PDF là định dạng tĩnh, vì vậy hoạt hình và chuyển tiếp không được bảo toàn. Mỗi trang trình bày trở thành một trang tĩnh.",
      },
      {
        question: "Định dạng .ppt có được hỗ trợ không?",
        answer:
          "Hiện tại chỉ định dạng .pptx được hỗ trợ. Vui lòng chuyển đổi tệp .ppt sang .pptx trước.",
      },
      {
        question: "Ghi chú của người trình bày có được bao gồm không?",
        answer:
          "Hiện tại, ghi chú của người trình bày không được bao gồm trong đầu ra PDF.",
      },
    ],
  },
  "xps-to-pdf": {
    title: "XPS sang PDF",
    metaDescription:
      "Chuyển đổi tài liệu XPS sang định dạng PDF. Chuyển đổi độ trung thực cao bảo toàn bố cục và đồ họa.",
    keywords: [
      "xps sang pdf",
      "chuyển đổi xps",
    ...
    howToUse: [
      {
        ...
        description:
          "Kéo và thả tệp .xps của bạn hoặc nhấp để chọn từ thiết bị của bạn.",
      },
      {
        step: 2,
        title: "Chờ xử lý",
    ...
    useCases: [
      {
        ...
        description:
          "Chuyển đổi tài liệu XPS sang định dạng PDF được hỗ trợ rộng hơn.",
        icon: "file",
      },
      {
        title: "Chia sẻ tài liệu",
        description:
          "Chia sẻ tài liệu XPS với người dùng không có trình xem XPS.",
        icon: "share-2",
      },
      {
    ...
    faq: [
      {
        ...
        answer:
          "XPS (XML Paper Specification) là định dạng tài liệu cố định của Microsoft, thường được sử dụng cho in ấn Windows.",
      },
      {
        question: "Việc chuyển đổi có không mất mát không?",
        answer:
          "Có, việc chuyển đổi bảo toàn văn bản, đồ họa và bố cục với độ trung thực cao.",
      },
      {
  ...
  "rtf-to-pdf": {
    title: "RTF sang PDF",
    metaDescription:
      "Chuyển đổi tệp RTF (Rich Text Format) sang PDF. Bảo toàn định dạng văn bản trong tài liệu của bạn.",
    keywords: [
      "rtf sang pdf",
      "chuyển đổi rtf",
    ...
    howToUse: [
      {
        ...
        description:
          "Kéo và thả tệp .rtf của bạn hoặc nhấp để chọn từ thiết bị của bạn.",
      },
      {
        step: 2,
        title: "Chờ xử lý",
    ...
    useCases: [
      ...
      },
      {
        title: "Chia sẻ tài liệu",
        description:
          "Chia sẻ tài liệu RTF ở định dạng PDF có thể xem phổ quát.",
        icon: "share-2",
      },
      {
        title: "Lưu trữ tài liệu",
        description:
          "Lưu trữ tệp RTF ở định dạng PDF ổn định để lưu trữ lâu dài.",
        icon: "archive",
      },
    ],
    faq: [
      {
        ...
        answer:
          "Định dạng văn bản cơ bản bao gồm phông chữ, đoạn văn và kiểu dáng được chuyển đổi. Tính năng RTF phức tạp có thể được đơn giản hóa.",
      },
      {
        question: "Tôi có thể chuyển đổi nhiều tệp RTF cùng lúc không?",
        answer:
          "Hiện tại, một tệp được chuyển đổi tại một thời điểm. Sử dụng Hợp nhất PDF để kết hợp nhiều tệp đã chuyển đổi.",
      },
      {
        question: "Hình ảnh nhúng có được hỗ trợ không?",
        answer:
          "Nội dung văn bản là trọng tâm chính. Đối tượng nhúng có thể không được kết xuất.",
      },
    ],
  },
  "epub-to-pdf": {
    title: "EPUB sang PDF",
    metaDescription:
      "Chuyển đổi sách điện tử EPUB sang PDF. Bảo toàn định dạng, hình ảnh và cấu trúc chương.",
    keywords: [
      "epub sang pdf",
      "chuyển đổi epub",
    ...
    howToUse: [
      {
        ...
        description:
          "Kéo và thả tệp .epub của bạn hoặc nhấp để chọn từ thiết bị của bạn.",
      },
      {
        step: 2,
        title: "Chờ chuyển đổi",
        description:
          "Công cụ sẽ kết xuất và chuyển đổi tất cả trang của sách điện tử của bạn.",
      },
      {
        step: 3,
        title: "Tải xuống PDF",
    ...
    useCases: [
      ...
      },
      {
        title: "Chia sẻ tài liệu",
        description:
          "Chia sẻ sách điện tử với bất kỳ ai, ngay cả khi không có thiết bị đọc sách điện tử.",
        icon: "share-2",
      },
    ],
    faq: [
      {
        ...
        answer:
          "Có! Công cụ này sử dụng kết xuất EPUB gốc, bảo toàn định dạng văn bản, hình ảnh và bố cục với độ trung thực cao.",
      },
      {
        question: "Sách điện tử được bảo vệ DRM có được hỗ trợ không?",
        answer:
          "Không, sách điện tử được bảo vệ DRM không thể chuyển đổi. Chỉ tệp EPUB không DRM được hỗ trợ.",
      },
      {
        question: "Kích thước trang được xác định như thế nào?",
        answer:
          "Nội dung EPUB được kết xuất thành kích thước trang A4 tiêu chuẩn để đọc tối ưu.",
      },
    ],
  },
  "mobi-to-pdf": {
    title: "MOBI sang PDF",
    metaDescription:
      "Chuyển đổi sách điện tử MOBI sang PDF. Hỗ trợ định dạng Kindle với kết xuất chất lượng cao.",
    keywords: [
      "mobi sang pdf",
      "chuyển đổi mobi",
      "kindle sang pdf",
    ...
    howToUse: [
      {
        ...
        description:
          "Kéo và thả tệp .mobi, .azw hoặc .azw3 của bạn hoặc nhấp để chọn từ thiết bị của bạn.",
      },
      {
        step: 2,
        title: "Chờ chuyển đổi",
    ...
    faq: [
      {
        ...
        answer:
          "Công cụ này hỗ trợ .mobi, .azw và .azw3 (phiên bản không DRM).",
      },
      {
        question: "Sách Kindle được bảo vệ DRM có được hỗ trợ không?",
        answer:
          "Không, sách điện tử được bảo vệ DRM không thể chuyển đổi. Chỉ tệp không DRM được hỗ trợ.",
      },
      {
        question: "Định dạng của tôi có được bảo toàn không?",
        answer:
          "Có! Công cụ sử dụng kết xuất MOBI gốc để bảo toàn văn bản, hình ảnh và bố cục.",
      },
    ],
  },
  "djvu-to-pdf": {
    title: "DJVU sang PDF",
    metaDescription:
      "Chuyển đổi tệp tài liệu DJVU sang PDF. Kết xuất chất lượng cao cho tài liệu đã quét và sách.",
    keywords: [
      "djvu sang pdf",
      "chuyển đổi djvu",
    ...
    howToUse: [
      {
        ...
        description:
          "Kéo và thả tệp .djvu hoặc .djv của bạn, hoặc nhấp để chọn từ thiết bị của bạn.",
      },
      {
        step: 2,
        title: "Định cấu hình tùy chọn",
        description:
          "Chọn DPI đầu ra (72, 150 hoặc 300) và chất lượng hình ảnh cho PDF.",
      },
      {
        step: 3,
        title: "Chuyển đổi & Tải xuống",
        description:
          "Nhấp Chuyển đổi sang PDF và tải xuống tài liệu đã chuyển đổi của bạn.",
      },
    ],
    useCases: [
      {
      ...
      },
      {
        ...
        description:
          "Chia sẻ sách đã quét ở định dạng PDF để tương thích rộng hơn.",
        icon: "share-2",
      },
      {
        title: "In tài liệu",
    ...
    faq: [
      {
        ...
        answer:
          "DjVu là định dạng tệp được thiết kế để lưu trữ tài liệu đã quét, đặc biệt là những tài liệu có văn bản, bản vẽ và hình ảnh. Nó cung cấp nén tốt hơn PDF cho nội dung đã quét.",
      },
      {
        question: "Tôi nên chọn DPI nào?",
        answer:
          "72 DPI phù hợp cho xem web, 150 DPI cho tài liệu tiêu chuẩn, và 300 DPI cho in ấn chất lượng cao.",
      },
      {
        question: "Văn bản có thể tìm kiếm không?",
        answer:
          "Văn bản được kết xuất dưới dạng hình ảnh. Nếu bạn cần văn bản có thể tìm kiếm, hãy sử dụng công cụ OCR PDF của chúng tôi sau khi chuyển đổi.",
      },
    ],
  },
  "fb2-to-pdf": {
    title: "FB2 sang PDF",
    metaDescription:
      "Chuyển đổi sách điện tử FictionBook (FB2) sang PDF. Hỗ trợ nhiều tệp với kết xuất chất lượng cao.",
    keywords: [
      "fb2 sang pdf",
      "chuyển đổi fb2",
    ...
    howToUse: [
      {
        ...
        description:
          "Kéo và thả một hoặc nhiều tệp .fb2 hoặc .fb2.zip, hoặc nhấp để chọn từ thiết bị của bạn.",
      },
      {
        step: 2,
        title: "Chọn chất lượng",
        description:
          "Chọn chất lượng đầu ra: Thấp (72 DPI), Trung bình (150 DPI) hoặc Cao (300 DPI).",
      },
      {
        step: 3,
        title: "Chuyển đổi & Tải xuống",
    ...
    useCases: [
      ...
      },
      {
        ...
        description:
          "Chia sẻ sách điện tử ở định dạng PDF hoạt động trên mọi thiết bị.",
        icon: "share-2",
      },
    ],
    faq: [
      {
        ...
        answer:
          "Có! Công cụ này hỗ trợ chuyển đổi hàng loạt lên đến 20 tệp FB2 cùng lúc.",
      },
      {
        question: "Tệp .fb2.zip có được hỗ trợ không?",
        answer:
          "Có, công cụ tự động trích xuất và chuyển đổi tệp FB2 từ kho lưu trữ .fb2.zip.",
      },
      {
        question: "Định dạng có được bảo toàn không?",
        answer:
          "Có! Công cụ sử dụng kết xuất FB2 gốc, bảo toàn định dạng văn bản, hình ảnh và cấu trúc chương với độ trung thực cao.",
      },
    ],
  },
  "pdf-to-jpg": {
    title: "PDF sang JPG",
    metaDescription:
      "Chuyển đổi trang PDF sang hình ảnh JPG. Trích xuất chất lượng cao với DPI có thể tùy chỉnh.",
    keywords: [
      "pdf sang jpg",
      "pdf sang jpeg",
    ...
    howToUse: [
      ...
      },
      {
        ...
        description:
          "Chọn trang nào để chuyển đổi và đặt tùy chọn DPI/chất lượng.",
      },
      {
        step: 3,
        title: "Chuyển đổi và tải xuống",
        description:
          "Nhấp Chuyển đổi để trích xuất hình ảnh và tải xuống dưới dạng ZIP.",
      },
    ],
    useCases: [
      {
        title: "Xuất bản web",
        description:
          "Chuyển đổi trang PDF sang hình ảnh để sử dụng trên trang web.",
        icon: "globe",
      },
      {
        title: "Mạng xã hội",
        description:
          "Trích xuất trang dưới dạng hình ảnh để chia sẻ trên mạng xã hội.",
        icon: "share-2",
      },
      {
        title: "Bản trình bày",
        description:
          "Chuyển đổi trang trình bày PDF sang hình ảnh cho bản trình bày.",
        icon: "presentation",
      },
    ],
    faq: [
      ...
      },
      {
        ...
        answer:
          "Có, bạn có thể chọn trang riêng lẻ hoặc phạm vi trang để chuyển đổi.",
      },
      {
        question: "Trang nhiều được xử lý như thế nào?",
        answer:
          "Mỗi trang trở thành một tệp JPG riêng biệt, được tải xuống dưới dạng kho lưu trữ ZIP.",
      },
    ],
  },
  "pdf-to-png": {
    title: "PDF sang PNG",
    metaDescription:
      "Chuyển đổi trang PDF sang hình ảnh PNG. Chất lượng không mất mát với hỗ trợ độ trong suốt.",
    keywords: [
      "pdf sang png",
    ...
    faq: [
      {
        ...
        answer:
          "PNG cung cấp nén không mất mát và hỗ trợ độ trong suốt, lý tưởng cho đồ họa và văn bản.",
      },
      {
        question: "Độ trong suốt nền có được hỗ trợ không?",
        answer:
          "Có, trang PDF với độ trong suốt được bảo toàn trong đầu ra PNG.",
      },
      {
  ...
  "pdf-to-webp": {
    title: "PDF sang WebP",
    metaDescription:
      "Chuyển đổi trang PDF sang hình ảnh WebP. Định dạng hiện đại với nén tuyệt vời.",
    keywords: [
      "pdf sang webp",
    ...
    useCases: [
      ...
      },
      {
        ...
        description:
          "Sử dụng định dạng hình ảnh hiện đại cho dự án web đương đại.",
        icon: "layout",
      },
    ],
    faq: [
      ...
      },
      {
        ...
        answer:
          "Hình ảnh WebP thường nhỏ hơn 25-35% so với hình ảnh JPG tương đương.",
      },
    ],
  },
  "pdf-to-bmp": {
    title: "PDF sang BMP",
    metaDescription:
      "Chuyển đổi trang PDF sang hình ảnh bitmap BMP. Định dạng không nén để tương thích tối đa.",
    keywords: [
      "pdf sang bmp",
    ...
    faq: [
      {
        ...
        answer:
          "BMP cung cấp chất lượng không nén và tương thích tối đa với hệ thống kế thừa.",
      },
      {
  ...
  "pdf-to-tiff": {
    title: "PDF sang TIFF",
    metaDescription:
      "Chuyển đổi PDF sang hình ảnh TIFF. Chất lượng chuyên nghiệp với hỗ trợ đa trang.",
    keywords: [
      "pdf sang tiff",
    ...
    faq: [
      {
        ...
        answer:
          "Có, bạn có thể kết hợp tất cả trang PDF thành một tệp TIFF đa trang duy nhất.",
      },
      {
        question: "Tùy chọn nén nào có sẵn?",
        answer: "Tùy chọn LZW, ZIP và không nén có sẵn.",
  ...
  "pdf-to-svg": {
    title: "PDF sang SVG",
    metaDescription:
      "Chuyển đổi trang PDF sang đồ họa vector SVG. Khả năng mở rộng hoàn hảo ở mọi kích thước với xuất trang riêng lẻ.",
    keywords: [
      "pdf sang svg",
    ...
    howToUse: [
      ...
      },
      {
        ...
        description:
          "Nhấp Chuyển đổi để xử lý. Nhấp vào hình thu nhỏ để xem trang SVG ở kích thước đầy đủ.",
      },
      {
        step: 4,
        title: "Tải xuống",
        description:
          "Tải xuống tệp SVG riêng lẻ hoặc tất cả dưới dạng kho lưu trữ ZIP.",
      },
    ],
    useCases: [
      {
        ...
        description:
          "Trích xuất logo và đồ họa vector từ PDF để sử dụng lại trong phần mềm thiết kế.",
        icon: "pen-tool",
      },
      {
        title: "Sơ đồ kỹ thuật",
        description:
          "Chuyển đổi bản vẽ kỹ thuật và sơ đồ sang định dạng SVG có thể mở rộng.",
        icon: "ruler",
      },
      {
        title: "Phát triển web",
        description:
          "Tạo tệp SVG sẵn sàng web từ nội dung PDF cho trang web đáp ứng.",
        icon: "globe",
      },
      {
    ...
    faq: [
      {
        ...
        answer:
          "SVG (Scalable Vector Graphics) là định dạng hình ảnh vector có thể mở rộng ở mọi kích thước mà không mất chất lượng. Nó được sử dụng rộng rãi cho logo, biểu tượng và đồ họa web.",
      },
      {
        question: "SVG có thực sự vector không?",
        answer:
          "SVG chứa kết xuất độ phân giải cao của trang PDF. Đối với PDF có nội dung vector, bạn nhận được đầu ra sắc nét ở mọi tỷ lệ.",
      },
      {
        question: "Tôi có thể xem trước trước khi tải xuống không?",
        answer:
          "Có! Nhấp vào bất kỳ hình thu nhỏ nào để xem SVG ở kích thước đầy đủ. Bạn có thể tải xuống trang riêng lẻ hoặc tất cả cùng lúc.",
      },
      {
        question: "Tôi nên chọn chất lượng DPI nào?",
        answer:
          "Chất lượng DPI cao hơn (216 hoặc 288 DPI) tạo SVG lớn hơn, chi tiết hơn. Dùng cài đặt thấp hơn cho xử lý nhanh hơn và tệp nhỏ hơn.",
      },
    ],
  },
  "pdf-to-greyscale": {
    title: "PDF sang Xám",
    metaDescription:
      "Chuyển đổi PDF màu sang xám. Giảm kích thước tệp và chuẩn bị cho in ấn đen trắng.",
    ...
    faq: [
      {
        ...
        answer:
          "Có, độ rõ ràng của văn bản được bảo toàn trong chuyển đổi xám.",
      },
      {
        question: "Kích thước tệp giảm bao nhiêu?",
        answer:
          "Kết quả thay đổi dựa trên nội dung PDF. PDF nặng màu có thể giảm 20-50%.",
      },
      {
        question: "Tôi có thể chuyển đổi chỉ trang cụ thể không?",
  ...
  "pdf-to-json": {
    title: "PDF sang JSON",
    metaDescription:
      "Trích xuất nội dung PDF sang định dạng JSON. Nhận dữ liệu có cấu trúc từ tài liệu PDF.",
    keywords: [
      "pdf sang json",
    ...
    howToUse: [
      ...
      },
      {
        ...
        description:
          "Chọn nội dung nào để trích xuất: văn bản, siêu dữ liệu, cấu trúc.",
      },
      {
        step: 3,
        title: "Trích xuất và tải xuống",
    ...
    faq: [
      {
        ...
        answer:
          "Nội dung văn bản, siêu dữ liệu, kích thước trang, phông chữ và cấu trúc tài liệu.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "PDF đã quét cần OCR trước. Sử dụng công cụ OCR PDF của chúng tôi trước khi trích xuất.",
      },
    ],
  },
  "pdf-to-pptx": {
    ...
    metaDescription:
      "Chuyển đổi PDF sang bản trình bày PowerPoint. Mỗi trang trở thành trang trình bày chất lượng cao.",
    keywords: [
      "pdf sang pptx",
      "pdf sang powerpoint",
    ...
    howToUse: [
      {
        ...
        title: "Tải lên PDF của bạn",
        description:
          "Kéo và thả tệp PDF của bạn hoặc nhấp để chọn từ thiết bị của bạn.",
      },
      {
        step: 2,
        title: "Chọn cài đặt chất lượng",
        description:
          "Chọn chất lượng hình ảnh (DPI) cho các trang trình bày. DPI cao hơn có nghĩa là chất lượng tốt hơn nhưng kích thước tệp lớn hơn.",
      },
      {
        step: 3,
        title: "Chuyển đổi và tải xuống",
        description:
          "Nhấp Chuyển đổi để tạo bản trình bày PowerPoint của bạn và tải xuống tệp PPTX.",
      },
    ],
    useCases: [
      {
        ...
        description:
          "Chuyển đổi báo cáo PDF thành trang trình bày cho các cuộc họp.",
        icon: "presentation",
      },
      {
        title: "Tài liệu đào tạo",
        description:
          "Biến đổi tài liệu đào tạo PDF thành bản trình bày PowerPoint tương tác.",
        icon: "book-open",
      },
      {
        title: "Tái sử dụng nội dung",
        description:
          "Chuyển đổi nội dung PDF hiện có thành định dạng trang trình bày có thể chỉnh sửa để tùy chỉnh thêm.",
        icon: "refresh-cw",
      },
    ],
    faq: [
      {
        ...
        answer:
          "Mỗi trang trình bày chứa hình ảnh chất lượng cao của trang PDF. Bạn có thể thêm văn bản, hình dạng và chú thích lên trên trong PowerPoint.",
      },
      {
        question: "Tôi nên chọn DPI nào?",
        answer:
          "Dùng 150 DPI cho bản trình bày hiển thị trên màn hình. Dùng 300 DPI cho in ấn hoặc khi bạn cần chất lượng cao nhất.",
      },
      {
        question: "Tôi có thể chuyển đổi PDF đa trang không?",
        answer:
          "Có, mỗi trang của PDF trở thành một trang trình bày riêng biệt trong bản trình bày PowerPoint.",
      },
    ],
  },
  "pdf-to-excel": {
    ...
    metaDescription:
      "Chuyển đổi PDF sang bảng tính Excel. Trích xuất bảng sang định dạng XLSX.",
    keywords: [
      "pdf sang excel",
      "pdf sang xlsx",
      "chuyển đổi bảng pdf",
    ...
    useCases: [
      {
        ...
        description:
          "Chuyển đổi sao kê ngân hàng hoặc hóa đơn sang Excel để phân tích.",
        icon: "trending-up",
      },
      {
        title: "Trích xuất dữ liệu",
    ...
    faq: [
      {
        ...
        answer:
          "Bảng được phát hiện trên mỗi trang được trích xuất thành các trang tính tương ứng trong tệp Excel.",
      },
      {
        question: "Điều gì nếu không có bảng?",
        answer:
          "Một trang tính thông tin sẽ được tạo để chỉ ra không tìm thấy bảng.",
      },
      {
        question: "Định dạng có được bảo toàn không?",
        answer:
          "Dữ liệu được bảo toàn, nhưng định dạng trực quan phức tạp có thể được đơn giản hóa cho bảng tính.",
      },
    ],
  },
  "ocr-pdf": {
    title: "OCR PDF",
    metaDescription:
      "Làm cho PDF đã quét có thể tìm kiếm với OCR. Trích xuất văn bản từ hình ảnh và tài liệu đã quét.",
    keywords: [
      "ocr pdf",
      "pdf có thể tìm kiếm",
      "nhận dạng văn bản",
    ...
    faq: [
      {
        ...
        answer:
          "Hơn 100 ngôn ngữ được hỗ trợ bao gồm tiếng Anh, tiếng Trung, tiếng Nhật, tiếng Hàn và nhiều hơn nữa.",
      },
      {
        question: "Bố cục gốc có được bảo toàn không?",
        answer:
          "Có, bố cục trực quan gốc được bảo toàn với lớp văn bản có thể tìm kiếm được thêm vào.",
      },
      {
        question: "OCR chính xác đến mức nào?",
        answer:
          "Độ chính xác phụ thuộc vào chất lượng quét nhưng thường vượt quá 95% cho tài liệu rõ ràng.",
      },
    ],
  },
  "alternate-merge": {
    ...
    metaDescription:
      "Hợp nhất PDF theo trang xen kẽ. Kết hợp quét mặt trước và mặt sau thành một tài liệu.",
    keywords: [
      "hợp nhất xen kẽ",
      "xen kẽ pdf",
      "kết hợp quét",
    ...
    howToUse: [
      ...
      },
      {
        ...
        description:
          "Chọn có đảo ngược tài liệu thứ hai cho quét mặt sau không.",
      },
      {
        step: 3,
        title: "Hợp nhất và tải xuống",
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "Hợp nhất thông thường nối tài liệu; hợp nhất xen kẽ xen kẽ trang.",
      },
    ],
  },
  "add-attachments": {
    ...
    metaDescription:
      "Nhúng tệp vào tài liệu PDF. Đính kèm bất kỳ loại tệp nào vào PDF của bạn.",
    keywords: [
      "tệp đính kèm pdf",
      "nhúng tệp",
      "đính kèm vào pdf",
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "Tổng kích thước PDF bao gồm tệp đính kèm không được vượt quá 500MB.",
      },
      {
        question: "Người nhận có thể trích xuất tệp đính kèm không?",
        answer:
          "Có, bất kỳ trình đọc PDF nào cũng có thể trích xuất tệp đính kèm nhúng.",
      },
    ],
  },
  "extract-attachments": {
    ...
    metaDescription:
      "Trích xuất tệp nhúng từ PDF. Tải xuống tất cả tệp đính kèm từ tài liệu PDF.",
    keywords: [
    ...
    faq: [
      ...
      },
      {
        question: "Tôi có thể trích xuất từ nhiều PDF không?",
        answer:
          "Có, bạn có thể xử lý nhiều PDF và tải xuống tất cả tệp đính kèm.",
      },
    ],
  },
  "extract-images": {
    ...
    metaDescription:
      "Trích xuất tất cả hình ảnh nhúng từ tệp PDF. Tải xuống riêng lẻ hoặc dưới dạng kho lưu trữ ZIP. Lọc hình ảnh nhỏ tự động.",
    keywords: [
      "trích xuất hình ảnh pdf",
      "trích xuất hình ảnh pdf",
    ...
    howToUse: [
      {
        ...
        title: "Tải lên PDF của bạn",
        description:
          "Kéo và thả một hoặc nhiều tệp PDF hoặc nhấp để chọn từ thiết bị của bạn.",
      },
      {
        step: 2,
        title: "Đặt tùy chọn lọc",
        description:
          "Điều chỉnh chiều rộng tối thiểu, chiều cao và kích thước tệp để lọc hình ảnh nhỏ không mong muốn.",
      },
      {
        step: 3,
        title: "Trích xuất hình ảnh",
        description:
          "Nhấp Trích xuất để tìm tất cả hình ảnh nhúng trong PDF của bạn.",
      },
      {
        step: 4,
        title: "Tải xuống",
        description:
          "Tải xuống hình ảnh riêng lẻ hoặc tất cả hình ảnh dưới dạng kho lưu trữ ZIP.",
      },
    ],
    useCases: [
      {
        title: "Khôi phục ảnh",
        description:
          "Trích xuất ảnh và hình ảnh nhúng trong tài liệu PDF để sử dụng lại hoặc lưu trữ.",
        icon: "image",
      },
      {
        title: "Thu thập tài sản",
        description:
          "Thu thập tất cả đồ họa và hình ảnh từ báo cáo PDF, bản trình bày hoặc brochure.",
        icon: "folder",
      },
      {
        title: "Tái sử dụng nội dung",
        description:
          "Trích xuất hình ảnh từ PDF để sử dụng trong tài liệu, trang web hoặc bản trình bày khác.",
        icon: "refresh-cw",
      },
    ],
    faq: [
      {
        ...
        answer:
          "Hình ảnh được trích xuất ở định dạng gốc của chúng (JPEG, PNG, v.v.) khi có thể, hoặc chuyển đổi sang PNG cho dữ liệu hình ảnh thô.",
      },
      {
        question: "Tại sao một số hình ảnh bị thiếu?",
        answer:
          "Hình ảnh nhỏ dưới ngưỡng kích thước bị lọc. Điều chỉnh cài đặt lọc để trích xuất hình ảnh nhỏ hơn.",
      },
      {
        question: "Tôi có thể trích xuất từ PDF đã quét không?",
        answer:
          "PDF đã quét thường chứa quét dưới dạng hình ảnh lớn mỗi trang. Sử dụng công cụ PDF sang Hình ảnh thay thế để chuyển đổi trang theo trang.",
      },
    ],
  },
  "edit-attachments": {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "Bạn có thể xem tên và kích thước tệp; sử dụng Trích xuất tệp đính kèm để xem nội dung.",
      },
    ],
  },
  "divide-pages": {
    title: "Chia trang",
    metaDescription:
      "Chia trang PDF thành nhiều phần. Chia trang theo chiều ngang hoặc dọc.",
    ...
    howToUse: [
      ...
      },
      {
        ...
        title: "Đặt chia",
        description:
          "Chọn chia theo chiều ngang, dọc hoặc lưới và đặt số phần.",
      },
      {
        step: 3,
    ...
    faq: [
      {
        ...
        answer:
          "Hiện tại, các phần chia đều. Sử dụng Cắt PDF cho phần tùy chỉnh.",
      },
      {
        question: "Nội dung ở đường chia được xử lý như thế nào?",
        answer:
          "Nội dung được tách ở đường chia; đảm bảo nội dung quan trọng không ở ranh giới.",
      },
      {
  ...
  "add-blank-page": {
    ...
    metaDescription:
      "Chèn trang trống vào tài liệu PDF. Thêm trang trống ở bất kỳ vị trí nào.",
    keywords: [
      "thêm trang trống",
      "chèn trang",
      "trang trống",
    ...
    faq: [
      {
        ...
        answer:
          "Có, trang trống có thể khớp với trang hiện có hoặc sử dụng kích thước tùy chỉnh.",
      },
      {
  ...
  "reverse-pages": {
    ...
    metaDescription:
      "Đảo ngược thứ tự trang PDF. Lật trang tài liệu từ cuối lên đầu.",
    keywords: [
      "đảo ngược pdf",
      "lật thứ tự trang",
      "đảo ngược trang",
    ...
    faq: [
      {
        ...
        answer:
          "Có, đánh dấu trang được cập nhật để trỏ đến trang đảo ngược chính xác.",
      },
      {
        question: "Tôi có thể đảo ngược chỉ một số trang không?",
      ...
      },
      {
        ...
        answer:
          "Không, đảo ngược thay đổi thứ tự trang; xoay thay đổi định hướng trang.",
      },
    ],
  },
  "rotate-pdf": {
    ...
    faq: [
      {
        ...
        answer:
          "Có, bạn có thể áp dụng xoay khác nhau cho các trang khác nhau.",
      },
      {
  ...
  "n-up-pdf": {
    title: "N-Up PDF",
    metaDescription:
      "In nhiều trang PDF mỗi tờ. Tạo bố cục 2-up, 4-up hoặc tùy chỉnh.",
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "Có, trang được sắp xếp theo thứ tự đọc (trái sang phải, trên xuống dưới).",
      },
    ],
  },
  "combine-single-page": {
    ...
    metaDescription:
      "Ghép trang PDF thành trang liên tục. Tạo tài liệu cuộn trang đơn.",
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "Kết quả tốt nhất cho xem màn hình; sử dụng N-Up cho bố cục in.",
      },
    ],
  },
  "view-metadata": {
    ...
    metaDescription:
      "Xem thuộc tính tài liệu PDF. Xem tác giả, tiêu đề, ngày tháng và siêu dữ liệu khác.",
    keywords: [
      "siêu dữ liệu pdf",
      "thuộc tính tài liệu",
      "thông tin pdf",
    ...
    howToUse: [
      ...
      },
      {
        ...
        description:
          "Xem tất cả siêu dữ liệu được hiển thị ở định dạng có tổ chức.",
      },
      {
        step: 3,
        title: "Xuất nếu cần",
    ...
    faq: [
      {
        ...
        answer:
          "Tiêu đề, tác giả, chủ đề, từ khóa, người tạo, nhà sản xuất, ngày tháng và phiên bản PDF.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Sử dụng công cụ Chỉnh sửa siêu dữ liệu để sửa đổi thuộc tính tài liệu.",
      },
    ],
  },
  "edit-metadata": {
    ...
    metaDescription:
      "Chỉnh sửa thuộc tính tài liệu PDF. Thay đổi tiêu đề, tác giả, chủ đề và từ khóa.",
    keywords: [
    ...
    howToUse: [
      ...
      },
      {
        ...
        description:
          "Sửa đổi tiêu đề, tác giả, chủ đề, từ khóa và các trường khác.",
      },
      {
        step: 3,
        title: "Lưu và tải xuống",
    ...
    useCases: [
      ...
      },
      {
        title: "Chuẩn bị tài liệu",
        description:
          "Chuẩn bị tài liệu với siêu dữ liệu thích hợp trước khi chia sẻ.",
        icon: "file-check",
      },
    ],
    faq: [
      {
        ...
        answer:
          "Tiêu đề, tác giả, chủ đề, từ khóa, người tạo và trường nhà sản xuất.",
      },
      {
        question: "Tôi có thể xóa tất cả siêu dữ liệu không?",
        answer:
          "Sử dụng công cụ Xóa siêu dữ liệu để loại bỏ tất cả thuộc tính tài liệu.",
      },
      {
  ...
  "compare-pdfs": {
    title: "So sánh PDF",
    metaDescription:
      "So sánh hai tài liệu PDF. Làm nổi bật sự khác biệt giữa các phiên bản.",
    keywords: [
      "so sánh pdf",
      "pdf diff",
      "so sánh tài liệu",
    ...
    howToUse: [
      ...
      },
      {
        ...
        description:
          "Xem sự khác biệt được làm nổi bật ở chế độ cạnh nhau hoặc chồng lên.",
      },
      {
        step: 3,
        title: "Xuất kết quả",
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "Có, chế độ chồng lên hiển thị sự khác biệt trực quan giữa các trang.",
      },
    ],
  },
  "posterize-pdf": {
    title: "Posterize PDF",
    metaDescription:
      "Chia trang PDF lớn thành ô in. Tạo áp phích từ trang PDF.",
    ...
    howToUse: [
      ...
      },
      {
        ...
        description:
          "Đặt kích thước lưới, chồng lên và kích thước giấy đầu ra.",
      },
      {
        step: 3,
        title: "Tạo và tải xuống",
    ...
    faq: [
      {
        ...
        answer:
          "Chồng lên 10-20mm được khuyến nghị để căn chỉnh dễ dàng trong quá trình lắp ráp.",
      },
      {
  ...
  "fix-page-size": {
    ...
    metaDescription:
      "Chuẩn hóa kích thước trang PDF. Chuyển đổi tất cả trang thành kích thước thống nhất.",
    keywords: [
    ...
    howToUse: [
      ...
      },
      {
        ...
        description:
          "Chọn kích thước tiêu chuẩn hoặc nhập kích thước tùy chỉnh.",
      },
      {
        step: 3,
        title: "Áp dụng và tải xuống",
    ...
    faq: [
      {
        ...
        answer:
          "Nội dung được chia tỷ lệ để vừa hoặc căn giữa kích thước trang mới.",
      },
      {
  ...
  "linearize-pdf": {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "Linearization có thể tăng nhẹ kích thước tệp do cấu trúc được thêm.",
      },
      {
  ...
  "page-dimensions": {
    ...
    metaDescription:
      "Phân tích kích thước trang PDF. Xem kích thước của tất cả trang trong tài liệu của bạn.",
    keywords: [
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "Sử dụng công cụ Khắc phục kích thước trang để chuẩn hóa kích thước.",
      },
    ],
  },
  "remove-restrictions": {
    ...
    metaDescription:
      "Loại bỏ hạn chế PDF. Mở khóa quyền in ấn, sao chép và chỉnh sửa.",
    keywords: [
      "loại bỏ hạn chế pdf",
      "mở khóa pdf",
      "quyền pdf",
    ...
    faq: [
      {
        ...
        answer:
          "Loại bỏ hạn chế từ tài liệu bạn sở hữu hoặc có quyền thường hợp pháp.",
      },
      {
  ...
  "repair-pdf": {
    title: "Sửa chữa PDF",
    metaDescription:
      "Khắc phục tệp PDF bị hỏng. Khôi phục và sửa chữa tài liệu bị hỏng.",
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "Công cụ khôi phục nhiều nhất có thể; tệp bị hỏng nghiêm trọng có thể có mất mát.",
      },
      {
  ...
  "encrypt-pdf": {
    ...
    howToUse: [
      ...
      },
      {
        ...
        title: "Đặt mật khẩu",
        description:
          "Nhập mật khẩu người dùng và/hoặc mật khẩu chủ sở hữu. Định cấu hình quyền.",
      },
      {
        step: 3,
    ...
    faq: [
      {
        ...
        answer:
          "Mật khẩu người dùng ngăn mở; mật khẩu chủ sở hữu kiểm soát quyền.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Có, bạn có thể đặt mật khẩu chủ sở hữu chỉ để kiểm soát quyền.",
      },
    ],
  },
  "sanitize-pdf": {
    title: "Vệ sinh PDF",
    metaDescription:
      "Loại bỏ dữ liệu ẩn khỏi PDF. Dọn dẹp siêu dữ liệu, tập lệnh và thông tin nhạy cảm.",
    keywords: [
      "vệ sinh pdf",
      "dọn dẹp pdf",
      "loại bỏ dữ liệu ẩn",
    ...
    faq: [
      {
        ...
        answer:
          "Siêu dữ liệu, tập lệnh, tệp đính kèm, nhận xét, dữ liệu biểu mẫu và lớp ẩn.",
      },
      {
        question: "Nội dung hiển thị có bị ảnh hưởng không?",
        answer:
          "Không, chỉ dữ liệu ẩn bị loại bỏ; nội dung tài liệu không thay đổi.",
      },
      {
        question: "Điều này có thể đảo ngược không?",
        answer:
          "Không, dữ liệu đã loại bỏ không thể khôi phục. Giữ bản sao của bản gốc.",
      },
    ],
  },
  "decrypt-pdf": {
    title: "Giải mã PDF",
    metaDescription:
      "Loại bỏ mật khẩu khỏi tệp PDF. Mở khóa tài liệu được bảo vệ bằng mật khẩu.",
    keywords: [
      "giải mã pdf",
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "Thật không may, chúng tôi không thể khôi phục mật khẩu bị quên.",
      },
    ],
  },
  "flatten-pdf": {
    title: "Làm phẳng PDF",
    metaDescription:
      "Làm phẳng biểu mẫu và chú thích PDF. Làm cho nội dung không thể chỉnh sửa.",
    keywords: [
      "làm phẳng pdf",
      "làm phẳng biểu mẫu",
      "làm phẳng chú thích",
    ...
    faq: [
      ...
      },
      {
        question: "Nó có giảm kích thước tệp không?",
        answer:
          "Đôi khi, vì các phần tử tương tác được chuyển đổi thành nội dung đơn giản hơn.",
      },
    ],
  },
  "remove-metadata": {
    ...
    metaDescription:
      "Loại bỏ siêu dữ liệu khỏi tệp PDF. Loại bỏ tác giả, ngày tháng và thuộc tính tài liệu.",
    keywords: [
    ...
    faq: [
      {
        ...
        answer:
          "Tác giả, tiêu đề, chủ đề, từ khóa, ngày tháng, người tạo và nhà sản xuất.",
      },
      {
      ...
      },
      {
        question: "Nội dung có bị ảnh hưởng không?",
        answer:
          "Không, chỉ siêu dữ liệu bị loại bỏ; nội dung tài liệu không thay đổi.",
      },
    ],
  },
  "change-permissions": {
    ...
    metaDescription:
      "Sửa đổi quyền PDF. Kiểm soát truy cập in ấn, sao chép và chỉnh sửa.",
    keywords: [
      "quyền pdf",
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "Có, với mật khẩu chủ sở hữu hoặc sử dụng công cụ Loại bỏ hạn chế.",
      },
      {
        question: "Tất cả trình đọc PDF có tương thích không?",
        answer:
          "Hầu hết trình đọc PDF tôn trọng quyền, nhưng một số có thể không thực thi chúng.",
      },
    ],
  },
  "pdf-to-docx": {
    title: "PDF sang Word",
    metaDescription:
      "Chuyển đổi PDF sang tài liệu Word có thể chỉnh sửa. Bảo toàn định dạng và bố cục.",
    keywords: [
      "pdf sang word",
      "docx sang pdf",
      "chuyển đổi word",
    ...
    useCases: [
      {
        ...
        description:
          "Chuyển đổi PDF hợp đồng sang Word để chỉnh sửa và sửa đổi.",
        icon: "file-text",
      },
      {
        title: "Cập nhật sơ yếu lý lịch",
        description:
          "Cập nhật sơ yếu lý lịch PDF cũ bằng cách chuyển đổi chúng sang Word.",
        icon: "user",
      },
      {
        title: "Tái sử dụng nội dung",
        description:
          "Trích xuất nội dung từ PDF báo cáo để sử dụng trong tài liệu khác.",
        icon: "copy",
      },
    ],
    faq: [
      {
        question: "Định dạng có được bảo toàn không?",
        answer:
          "Có, công cụ cố gắng bảo toàn bố cục, phông chữ và hình ảnh một cách chính xác nhất có thể.",
      },
      {
        question: "Tôi có thể chuyển đổi PDF đã quét không?",
        answer:
          "PDF đã quét sẽ được chuyển đổi dưới dạng hình ảnh trong Word trừ khi bạn sử dụng OCR trước.",
      },
      {
        question: "Nó có tương thích với Word không?",
        answer:
          "Có, đầu ra là tệp .docx tiêu chuẩn tương thích với Microsoft Word và Google Docs.",
      },
    ],
  },
  "deskew-pdf": {
    title: "Deskew PDF",
    metaDescription:
      "Tự động làm thẳng trang PDF đã quét hoặc bị nghiêng. Khắc phục tài liệu bị lệch với độ chính xác góc phát hiện.",
    keywords: [
      "deskew pdf",
      "làm thẳng pdf",
      "khắc phục quét lệch",
    ...
    howToUse: [
      ...
      },
      {
        ...
        title: "Định cấu hình cài đặt",
        description:
          "Điều chỉnh độ nhạy ngưỡng và DPI nếu cần để phát hiện tốt hơn.",
      },
      {
        step: 3,
        title: "Xử lý và tải xuống",
        description:
          "Nhấp Deskew để làm thẳng trang và tải xuống PDF đã sửa chữa.",
      },
    ],
    useCases: [
      {
        title: "Tài liệu đã quét",
        description:
          "Khắc phục trang được quét theo góc từ máy cấp giấy tài liệu.",
        icon: "scan",
      },
      {
        title: "Quét di động",
        description:
          "Sửa chữa ảnh bị nghiêng của tài liệu được chụp bằng điện thoại thông minh.",
        icon: "smartphone",
      },
      {
    ...
    faq: [
      {
        ...
        answer:
          "Công cụ có thể phát hiện và sửa chữa góc nhỏ đến 0.1 độ để căn chỉnh chính xác.",
      },
      {
        question: "Chất lượng văn bản có bị ảnh hưởng không?",
        answer:
          "Quá trình deskew duy trì chất lượng văn bản trong khi xoay nội dung trang.",
      },
      {
        question: "Tôi có thể deskew chỉ trang cụ thể không?",
        answer:
          "Công cụ xử lý tất cả trang nhưng chỉ sửa chữa những trang được phát hiện là bị lệch.",
      },
    ],
  },
  "pdf-booklet": {
    ...
    metaDescription:
      "Sắp xếp bố cục booklet từ PDF để in. Sắp xếp trang cho ràng buộc saddle-stitch với nhiều tùy chọn lưới.",
    keywords: [
      "pdf booklet",
      "trình tạo booklet",
      "in booklet",
    ...
    howToUse: [
      ...
      },
      {
        ...
        title: "Chọn bố cục",
        description:
          "Chọn chế độ lưới, kích thước giấy, định hướng và tùy chọn xoay.",
      },
      {
        step: 3,
        title: "Tạo và tải xuống",
    ...
    useCases: [
      ...
      },
      {
        title: "Zine",
        description:
          "Sản xuất zine tự xuất bản với imposition trang thích hợp.",
        icon: "book",
      },
      {
    ...
    faq: [
      {
        ...
        answer:
          "Saddle-stitch là phương pháp ràng buộc nơi các tờ gấp được lồng vào nhau và đóng ghim qua nếp gấp.",
      },
      {
        question: "Chế độ lưới nào tôi nên sử dụng?",
        answer:
          "1x2 là tiêu chuẩn cho booklet. Sử dụng 2x2 hoặc lớn hơn để in nhiều trang để tiết kiệm giấy.",
      },
      {
        question: "Tôi có thể xem trước bố cục không?",
        answer:
          "Có, công cụ cung cấp xem trước trực quan trước khi tạo booklet cuối cùng.",
      },
    ],
  },
  "rasterize-pdf": {
    title: "Rasterize PDF",
    metaDescription:
      "Chuyển đổi trang PDF thành hình ảnh chất lượng cao. Xuất dưới dạng PNG, JPEG hoặc WebP với cài đặt DPI tùy chỉnh.",
    keywords: [
      "rasterize pdf",
      "pdf sang hình ảnh",
      "pdf sang png",
    ...
    howToUse: [
      ...
      },
      {
        ...
        title: "Định cấu hình đầu ra",
        description:
          "Chọn DPI, định dạng đầu ra (PNG/JPEG/WebP), chất lượng và phạm vi trang.",
      },
      {
        step: 3,
        title: "Chuyển đổi và tải xuống",
        description:
          "Xử lý trang và tải xuống hình ảnh riêng lẻ hoặc dưới dạng kho lưu trữ ZIP.",
      },
    ],
    useCases: [
      {
        title: "Mạng xã hội",
        description:
          "Chuyển đổi trang trình bày PDF sang hình ảnh để đăng mạng xã hội.",
        icon: "share-2",
      },
      {
        title: "Hình thu nhỏ",
      ...
      },
      {
        title: "Xuất bản web",
        description:
          "Chuyển đổi nội dung PDF sang định dạng hình ảnh thân thiện với web.",
        icon: "globe",
      },
    ],
    faq: [
      {
        question: "Tôi nên dùng DPI nào?",
        answer:
          "72 DPI cho xem màn hình, 150 DPI cho tài liệu tiêu chuẩn, 300 DPI cho chất lượng in.",
      },
      {
        question: "Định dạng nào tốt nhất?",
        answer:
          "PNG cho chất lượng/độ trong suốt, JPEG cho kích thước nhỏ, WebP cho web hiện đại.",
      },
      {
        question: "Tôi có thể chuyển đổi chỉ trang cụ thể không?",
        answer:
          'Có, chỉ định phạm vi trang như "1-5, 8, 10-15" để chuyển đổi chỉ những trang đó.',
      },
    ],
  },
  "markdown-to-pdf": {
    ...
    metaDescription:
      "Chuyển đổi tệp Markdown thành tài liệu PDF được định dạng đẹp. Hỗ trợ GitHub Flavored Markdown và làm nổi bật cú pháp.",
    keywords: [
      "markdown sang pdf",
      "md sang pdf",
      "chuyển đổi markdown",
    ...
    useCases: [
      {
        title: "Tài liệu",
        description:
          "Chuyển đổi tệp README và tài liệu sang PDF có thể chia sẻ.",
        icon: "file-text",
      },
      {
        title: "Xuất ghi chú",
    ...
    faq: [
      {
        ...
        answer:
          "Có, bảng, danh sách nhiệm vụ, gạch ngang và các tính năng GFM khác được hỗ trợ.",
      },
      {
        question: "Tôi có thể tùy chỉnh định dạng không?",
        answer:
          "Chọn từ chủ đề đặt sẵn hoặc thêm CSS tùy chỉnh để kiểm soát đầy đủ.",
      },
      {
        question: "Khối mã có được làm nổi bật không?",
        answer:
          "Có, khối mã bao gồm làm nổi bật cú pháp cho các ngôn ngữ phổ biến.",
      },
    ],
  },
  "email-to-pdf": {
    ...
    metaDescription:
      "Chuyển đổi tệp email (.eml) sang tài liệu PDF. Bảo toàn định dạng, hình ảnh nội tuyến và tệp đính kèm.",
    keywords: [
      "email sang pdf",
      "eml sang pdf",
      "chuyển đổi email",
    ...
    useCases: [
      {
        title: "Hồ sơ pháp lý",
        description:
          "Lưu trữ email quan trọng dưới dạng PDF để ghi nhận pháp lý.",
        icon: "scale",
      },
      {
      ...
      },
      {
        ...
        description:
          "Lưu bằng chứng email ở định dạng PDF không thể chỉnh sửa.",
        icon: "shield",
      },
    ],
    faq: [
      ...
      },
      {
        ...
        answer:
          "Tên tệp đính kèm được liệt kê trong PDF. Tệp thực tế không được nhúng.",
      },
      {
        question: "Định dạng email có được bảo toàn không?",
        answer:
          "Có, email HTML duy trì định dạng của chúng một cách chính xác nhất có thể.",
      },
    ],
  },
  "cbz-to-pdf": {
    title: "CBZ sang PDF",
    metaDescription:
      "Chuyển đổi kho lưu trữ truyện tranh (CBZ) sang PDF. Bảo toàn thứ tự hình ảnh và chất lượng để truyện tranh kỹ thuật số.",
    keywords: [
      "cbz sang pdf",
    ...
    useCases: [
      ...
      },
      {
        ...
        description:
          "Tạo lưu trữ PDF của bộ sưu tập truyện tranh kỹ thuật số của bạn.",
        icon: "archive",
      },
      {
        title: "Chuẩn bị in ấn",
    ...
    faq: [
      {
        ...
        answer:
          "CBZ là kho lưu trữ ZIP chứa trang truyện tranh dưới dạng tệp hình ảnh, được đổi tên với phần mở rộng .cbz.",
      },
      {
        question: "Chất lượng hình ảnh có được bảo toàn không?",
      ...
      },
      {
        ...
        answer:
          "Có, hình ảnh từ tất cả thư mục trong kho lưu trữ được trích xuất và sắp xếp.",
      },
    ],
  },
  "pdf-to-pdfa": {
    ...
    metaDescription:
      "Chuyển đổi PDF sang định dạng lưu trữ PDF/A. Đảm bảo bảo quản tài liệu lâu dài với tiêu chuẩn ISO.",
    keywords: [
      "pdf sang pdfa",
    ...
    useCases: [
      {
        ...
        description:
          "Chuyển đổi tài liệu pháp lý sang PDF/A để lưu trữ lâu dài có thể chấp nhận tòa án.",
        icon: "scale",
      },
      {
      ...
      },
      {
        title: "Lưu trữ kinh doanh",
        description:
          "Bảo quản tài liệu kinh doanh quan trọng để truy cập trong tương lai.",
        icon: "archive",
      },
    ],
    faq: [
      {
        ...
        answer:
          "PDF/A-2b được khuyến nghị cho hầu hết sử dụng. Sử dụng 1b cho tương thích tối đa hoặc 3b nếu bạn cần tệp nhúng.",
      },
      {
        question: "Điều gì làm PDF/A khác biệt?",
        answer:
          "PDF/A nhúng phông chữ, vô hiệu hóa mã hóa và đảm bảo tất cả phần tử tự chứa cho xem trong tương lai.",
      },
      {
        question: "Tôi có thể chuyển đổi từ PDF/A không?",
        answer:
          "Tệp PDF/A là PDF tiêu chuẩn và có thể mở bình thường. Các tính năng lưu trữ thêm hạn chế, không phải giới hạn.",
      },
    ],
  },
  "font-to-outline": {
    ...
    metaDescription:
      "Chuyển đổi phông chữ PDF sang đường viền vector. Đảm bảo tương thích khi phông chữ có thể không khả dụng.",
    keywords: [
    ...
    howToUse: [
      ...
      },
      {
        ...
        title: "Định cấu hình tùy chọn",
        description:
          "Đặt DPI cho rasterization nếu cần cho phông chữ phức tạp.",
      },
      {
        step: 3,
        title: "Chuyển đổi và tải xuống",
    ...
    useCases: [
      {
        title: "Chuẩn bị in ấn",
        description:
          "Đảm bảo phông chữ hiển thị chính xác tại nhà in thương mại.",
        icon: "printer",
      },
      {
        title: "Chia sẻ đa nền tảng",
    ...
    faq: [
      {
        ...
        answer:
          "Không, văn bản outline trở thành đồ họa vector và không còn có thể tìm kiếm hoặc chọn được.",
      },
      {
        question: "Kích thước tệp có tăng không?",
        answer:
          "Kích thước tệp có thể tăng vì vector có thể lớn hơn dữ liệu phông chữ, đặc biệt cho phông chữ phức tạp.",
      },
      {
        question: "Điều này có thể đảo ngược không?",
        answer:
          "Không, giữ bản sao của bản gốc nếu bạn cần văn bản có thể chỉnh sửa.",
      },
    ],
  },
  "extract-tables": {
    ...
    metaDescription:
      "Phát hiện và trích xuất bảng từ tài liệu PDF. Xuất sang định dạng JSON, Markdown hoặc CSV.",
    keywords: [
      "trích xuất bảng",
      "trích xuất bảng pdf",
      "pdf sang csv",
    ...
    useCases: [
      {
        ...
        description:
          "Trích xuất dữ liệu bảng để phân tích trong bảng tính hoặc cơ sở dữ liệu.",
        icon: "bar-chart",
      },
      {
        title: "Xử lý báo cáo",
    ...
    faq: [
      {
        ...
        answer:
          "Công cụ hoạt động tốt nhất với bảng lưới đơn giản. Ô được hợp nhất phức tạp có thể cần điều chỉnh thủ công.",
      },
      {
        question: "Điều gì nếu không tìm thấy bảng?",
        answer:
          "Thử điều chỉnh ngưỡng cột/hàng tối thiểu hoặc kiểm tra xem PDF có chứa cấu trúc bảng thực tế không.",
      },
      {
        question: "Tôi có thể trích xuất từ trang cụ thể không?",
        answer:
          "Có, chỉ định phạm vi trang để giới hạn trích xuất ở các trang nhất định.",
      },
    ],
  },
  "ocg-manager": {
    ...
    metaDescription:
      "Quản lý lớp PDF (Nhóm nội dung tùy chọn). Xem, bật/tắt, thêm, xóa và đổi tên lớp trong tài liệu PDF của bạn.",
    keywords: [
      "lớp pdf",
      "trình quản lý ocg",
    ...
    howToUse: [
      {
        ...
        title: "Tải lên PDF của bạn",
        description:
          "Tải lên tệp PDF có lớp (OCG) hoặc tệp bạn muốn thêm lớp vào.",
      },
      {
        step: 2,
        title: "Xem lớp",
        description:
          "Công cụ tự động liệt kê tất cả lớp được tìm thấy trong tài liệu với trạng thái khả năng hiển thị của chúng.",
      },
      {
        step: 3,
        title: "Quản lý lớp",
        description:
          "Bật/tắt khả năng hiển thị lớp, đổi tên lớp, thêm lớp mới hoặc xóa lớp không mong muốn.",
      },
      {
        step: 4,
        title: "Lưu và tải xuống",
        description:
          "Tải xuống PDF đã sửa đổi của bạn với thay đổi lớp được áp dụng.",
      },
    ],
    useCases: [
      {
        title: "Bản vẽ kỹ thuật",
        description:
          "Quản lý lớp trong xuất CAD để hiển thị/ẩn kích thước, chú thích hoặc chế độ xem khác nhau.",
        icon: "ruler",
      },
      {
        title: "Chỉnh sửa bản đồ",
        description:
          "Bật/tắt các lớp bản đồ khác nhau như địa hình, đường phố và nhãn để in bản đồ tùy chỉnh.",
        icon: "map",
      },
      {
        title: "Chuẩn bị in ấn",
        description:
          "Chuẩn bị PDF có lớp để in bằng cách bật/tắt lớp thích hợp cho các phiên bản khác nhau.",
        icon: "printer",
      },
    ],
    faq: [
      {
        ...
        answer:
          "Nhóm nội dung tùy chọn (OCG) là lớp trong PDF có thể được hiển thị hoặc ẩn. Chúng thường được thêm trong quá trình tạo PDF từ phần mềm thiết kế hoặc CAD.",
      },
      {
        question: "Tại sao PDF của tôi hiển thị không có lớp?",
        answer:
          "Không phải tất cả PDF chứa lớp. Lớp thường được thêm trong quá trình tạo PDF từ phần mềm thiết kế hoặc CAD.",
      },
      {
        question:
          "Thay đổi khả năng hiển thị lớp có ảnh hưởng đến nội dung gốc không?",
        answer:
          "Thay đổi khả năng hiển thị lớp chỉ ảnh hưởng đến nội dung được hiển thị hoặc in. Nội dung thực tế vẫn còn trong tài liệu.",
      },
    ],
  },
  "pdf-reader": {
    title: "Trình đọc PDF",
    metaDescription:
      "Trình đọc PDF trực tuyến miễn phí. Xem, điều hướng, thu phóng, xoay và in tài liệu PDF trực tiếp trong trình duyệt của bạn.",
    keywords: [
      "trình đọc pdf",
      "trình xem pdf",
      "xem pdf trực tuyến",
    ...
    howToUse: [
      {
        ...
        description:
          "Nhấp để tải lên hoặc kéo và thả tệp PDF để mở trong trình đọc.",
      },
      {
        step: 2,
        title: "Điều hướng trang",
        description:
          "Sử dụng điều khiển trang để đi đến trang trước hoặc trang tiếp theo, hoặc nhảy đến số trang cụ thể.",
      },
      {
        step: 3,
        title: "Điều chỉnh chế độ xem",
        description:
          "Thu phóng vào hoặc ra, xoay chế độ xem hoặc nhập chế độ toàn màn hình để đọc thoải mái.",
      },
      {
        step: 4,
        title: "In hoặc tải xuống",
        description:
          "In tài liệu hoặc tải xuống để truy cập ngoại tuyến khi cần.",
      },
    ],
    useCases: [
      {
        title: "Xem xét tài liệu",
        description:
          "Xem nhanh tài liệu PDF mà không cần cài đặt bất kỳ phần mềm nào.",
        icon: "book-open",
      },
      {
        title: "Đọc di động",
        description:
          "Đọc tài liệu PDF trên bất kỳ thiết bị nào có trình duyệt web.",
        icon: "smartphone",
      },
      {
        title: "Xem trước nhanh",
        description:
          "Xem trước PDF trước khi quyết định tải xuống hoặc in chúng.",
        icon: "eye",
      },
    ],
    faq: [
      {
        ...
        answer:
          "Có, tài liệu của bạn được xử lý hoàn toàn trong trình duyệt của bạn và không được tải lên bất kỳ máy chủ nào.",
      },
      {
        question: "Tôi có thể chú thích hoặc chỉnh sửa PDF không?",
        answer:
          "Công cụ này chỉ dành cho xem. Sử dụng công cụ Ký PDF hoặc Chú thích PDF của chúng tôi để chỉnh sửa.",
      },
      {
        question: "Nó có hoạt động trên thiết bị di động không?",
        answer:
          "Có, trình đọc PDF hoạt động trên tất cả thiết bị có trình duyệt web hiện đại.",
      },
    ],
  },
  "form-logic-designer": {
    ...
    metaDescription:
      "Thiết kế các hành vi động bằng khung hình nút giả kính và nhúng logic AcroJS tương tác vào biểu mẫu PDF.",
    keywords: [
      "logic biểu mẫu PDF",
      "nhúng AcroJS",
      "dòng nút",
    ...
    howToUse: [
      {
        ...
        description:
          "Cung cấp tệp PDF đã có sẵn các trường biểu mẫu hoạt động (AcroForm).",
      },
      {
        step: 2,
        title: "Thiết Lập Logic Trên Khung Hình",
        description:
          "Kết nối các trường dưới dạng nút. Liên kết các sự kiện đầu ra (thay đổi, mất tập trung) với các hành động đích (hiển thị, ẩn, tính toán, vô hiệu hóa).",
      },
      {
        step: 3,
        title: "Biên Dịch và Nhúng",
        description:
          "Nhúng logic JavaScript đã biên dịch vào từ điển PDF và lưu tài liệu thông minh cuối cùng.",
      },
    ],
    useCases: [
      {
        ...
        description:
          "Hiển thị hoặc ẩn các trường nhập bổ sung một cách linh hoạt dựa trên các điều khoản đã chọn của khách hàng.",
        icon: "file-signature",
      },
      {
        title: "Biểu Mẫu Chi Phí Tự Động",
        description:
          "Cộng nhiều dòng chi phí và tính thuế một cách linh hoạt mà không cần tính toán thủ công.",
        icon: "calculator",
      },
      {
        title: "Bảng Câu Hỏi Tương Tác",
        description:
          "Bỏ qua các câu hỏi không liên quan dựa trên các câu trả lời trước đó, mang lại trải nghiệm điền trên thiết bị di động gọn gàng hơn.",
        icon: "form-input",
      },
    ],
    faq: [
      {
        ...
        answer:
          "Có. Công cụ này được thiết kế để liên kết các quy tắc logic với các trường hiện có. Nếu PDF của bạn không có các trường tương tác, trước tiên hãy sử dụng công cụ Tạo Biểu Mẫu của chúng tôi để thêm các ô nhập và hộp kiểm.",
      },
      {
        question: "Logic này có chạy trên mọi trình đọc PDF không?",
        answer:
          "Nó chạy trên tất cả các trình đọc PDF tuân thủ tiêu chuẩn Adobe PDF và hỗ trợ Acrobat JavaScript (như Adobe Acrobat Reader, Foxit Reader và các trình duyệt web lớn). Trình đọc di động tối giản có thể chỉ hỗ trợ các hành động cơ bản.",
      },
      {
        question: "Điều này có ảnh hưởng đến việc in giấy không?",
        answer:
          "Hoàn toàn không. Các tập lệnh được nhúng chỉ chạy trên màn hình trong quá trình điền biểu mẫu. Khi in, trạng thái hiện tại của các trường được in tĩnh mà không có bất kỳ hình ảnh hiển thị nút nào.",
      },
    ],
  },
  "global-invoice-parser": {
    ...
    metaDescription:
      "Trích xuất tổng số tiền từ hóa đơn đa quốc gia, thực hiện các phép tính và đóng dấu sổ cái tỷ giá hối đoái giả kính tương tác.",
    keywords: [
      "dịch hóa đơn",
    ...
    howToUse: [
      {
        ...
        description:
          "Nhập bất kỳ hóa đơn nào được lập hóa đơn bằng ngoại tệ (ví dụ: USD, EUR, JPY).",
      },
      {
        step: 2,
        title: "Chọn Tiền Tệ Bản Địa",
        description:
          "Chọn tiền tệ bản địa của bạn (ví dụ: VND) và chỉ định tỷ giá tùy chỉnh hoặc thời gian thực.",
      },
      {
        step: 3,
        title: "Áp Dụng Dấu Sổ Cái",
        description:
          "Nhấp vào thực thi để phủ dấu sổ cái tỷ giá hối đoái sẵn sàng cho kế toán.",
      },
    ],
    useCases: [
      {
        ...
        description:
          "Chuyển đổi hóa đơn du lịch sang tiền tệ bản địa và đóng dấu chi tiết chuyển đổi, đơn giản hóa quy trình làm việc kế toán.",
        icon: "plane",
      },
      {
        title: "Kiểm Toán Mua Sắm Xuyên Biên Giới",
        description:
          "Dịch các cột hóa đơn và cô lập chi phí thực tế của hàng hóa thương mại điện tử.",
        icon: "credit-card",
      },
      {
        title: "Ghi Sổ Doanh Nghiệp Quốc Tế",
        description:
          "Đóng dấu sổ cái chuyển đổi nhất quán trên các hóa đơn của công ty để hợp lý hóa các cuộc kiểm toán cuối năm.",
        icon: "folder-open",
      },
    ],
    faq: [
      {
        ...
        answer:
          'Nó quét các luồng ký tự để tìm các ký hiệu tiền tệ và phân tích các tiêu đề ngữ nghĩa như "Total" hoặc "Due" để xác định tổng số tiền cuối cùng của hóa đơn.',
      },
      {
        question: "Tỷ giá hối đoái có được tìm nạp theo thời gian thực không?",
        answer:
          "Yes. Theo mặc định, nó truy xuất tỷ giá cơ sở từ các API tài chính tiêu chuẩn. Bạn cũng có thể chỉ định tỷ giá tùy chỉnh cho các cuộc kiểm toán nội bộ.",
      },
      {
        question:
          "Dấu được đóng có che khuất các chi tiết hóa đơn quan trọng không?",
        answer:
          "Công cụ quét lề trang để tìm vị trí tối ưu. Dấu có màu bán trong suốt, căn chỉnh trang nhã với bố cục của bạn.",
      },
    ],
  },
  "pdf-to-cbz": {
    title: "PDF sang CBZ",
    metaDescription:
      "Chuyển đổi tệp PDF sang kho lưu trữ truyện tranh CBZ. Giữ nguyên thứ tự và chất lượng hình ảnh.",
    keywords: ["pdf sang cbz", "chuyển đổi cbz", "truyện tranh pdf"],
    description:
  ...
  "overlay-pdf": {
    title: "Đè chồng PDF",
    metaDescription:
      "Đè chồng hai trang PDF thành một trang duy nhất. Lý tưởng cho việc chèn con dấu, hình nền và hình mờ.",
    keywords: ["đè chồng pdf", "pdf overlay", "chèn con dấu pdf"],
    description:
    ...
    howToUse: [
      ...
      },
      {
        ...
        description:
          "Provide the overlay/underlay document that acts as the layer.",
      },
      {
        step: 3,
        title: "Configure Layering",
        description:
          "Choose overlay or underlay mode, specify page ranges, and enable page looping.",
      },
      {
        step: 4,
        title: "Compile and Download",
        description:
          "Click Compile to process and download the layered result PDF.",
      },
    ],
    useCases: [
      {
        ...
        description:
          "Layer invoice contents on top of standard company letterhead templates.",
        icon: "file-text",
      },
      {
        title: "Watermarks & Seals",
        description:
          "Overlay security stamps, signature seals, or backgrounds across documents.",
        icon: "shield",
      },
      {
        title: "Drawing Blueprints",
        description:
          "Combine draft architectures or layout grids underneath text blocks.",
        icon: "layout",
      },
    ],
    faq: [
      {
        ...
        answer:
          "Overlay places the secondary layer on top of your main content. Underlay places it at the very bottom, acting as a background template.",
      },
      {
        question: "Can I loop the overlay layer?",
        answer:
          "Yes, if the layer PDF is shorter than the base document, enabling Loop will cycle it (e.g. page 1, 2, 1, 2) to cover all base pages.",
      },
      {
        question: "Is page range supported?",
        answer:
          'Yes, you can target specific pages using range syntax such as "1-5", "odd", "even", or comma-separated lists.',
      },
    ],
  },
  "timestamp-pdf": {
    ...
    metaDescription:
      "Nhúng dấu thời gian bảo mật RFC 3161 vào tài liệu PDF để xác minh thời gian tạo và chống giả mạo.",
    keywords: ["đóng dấu thời gian pdf", "rfc 3161", "xác thực thời gian"],
    description:
  ...
  "add-page-labels": {
    ...
    metaDescription:
      "Thiết lập nhãn trang tùy chỉnh (ví dụ: I, II cho lời mở đầu, 1, 2 cho nội dung). Cải thiện điều hướng trình đọc.",
    keywords: ["nhãn trang pdf", "đánh số trang logic", "điều hướng pdf"],
    description:
    ...
    howToUse: [
      ...
      },
      {
        ...
        description:
          'Add one or more rules specifying page ranges (e.g., "1-5", "odd", or comma-separated lists), prefix, style, and starting sequence.',
      },
      {
        step: 3,
        title: "Preview and Download",
        description:
          "Review the live page label list preview below, then compile and download your updated PDF document.",
      },
    ],
    useCases: [
      {
        ...
        description:
          "Set lowercase Roman numerals (i, ii, iii) for introductory front matter and transition to decimal for main chapters.",
        icon: "book",
      },
      {
        title: "Engineering Blueprint Prefixes",
        description:
          'Attach subsystem abbreviations (e.g., "A-1", "M-5") as page label prefixes, letting teams search and locate pages in seconds.',
        icon: "layout",
      },
      {
        title: "Custom Alternating Layouts",
        description:
          "Apply highly specific page range indexing to odd/even sequences or non-contiguous sections with maximum freedom.",
        icon: "shuffle",
      },
    ],
    faq: [
      {
        ...
        answer:
          "Ordinary page numbers are visual text blocks rendered directly on the paper canvas (visible when printed). Page labels, however, are structural metadata injected into the PDF catalog. They control what is displayed underneath thumbnails and in the page lookup box inside software like Adobe Acrobat or Apple Preview.",
      },
      {
        question: "What happens if I leave the Page Range empty?",
        answer:
          "Leaving the page range empty causes the rule to apply globally to all pages of the document.",
      },
      {
        question: "How are overlapping rules handled?",
        answer:
          "Rules are evaluated sequentially in the order they are listed. If a page range of a later rule overlaps with an earlier one, the later rule takes priority and overrides the label for that page.",
      },
    ],
  },
  "ai-pdf-reflower": {
    ...
    metaDescription:
      "Tái cấu trúc tài liệu PDF thành bố cục tương thích với thiết bị di động. Hỗ trợ xuất sang Markdown và EPUB.",
    keywords: [
      "dàn trang pdf",
      "pdf tự thích ứng",
      "pdf sang markdown",
    ...
    howToUse: [
      ...
      },
      {
        ...
        description:
          "Choose your preferred font size and theme colors in the 3D mobile simulator on the right.",
      },
      {
        step: 3,
        title: "Export Document",
        description:
          "Once satisfied, use the physical pull-rope to export the document as Markdown or EPUB.",
      },
    ],
    useCases: [
      {
        ...
        description:
          "Read academic papers and research reports on your phone seamlessly without constant zooming.",
        icon: "smartphone",
      },
      {
        title: "Ebook Conversion",
        description:
          "Convert text-heavy PDFs into EPUB files and import them into Kindle or other ebook readers.",
        icon: "book",
      },
      {
        title: "Note Archive",
        description:
          "Directly convert structured PDF content into clean Markdown files for your personal knowledge base.",
        icon: "file-text",
      },
    ],
    faq: [
      {
        ...
        answer:
          "Yes, the layout reflower detects the horizontal coordinates of text blocks and structures left and right columns sequentially, preventing line interleaving.",
      },
      {
        question: "Will images and math formulas be lost?",
        answer:
          "Mathematical formulas are converted to LaTeX/MathJax syntax for clean web rendering, and images are preserved in their corresponding semantic positions.",
      },
      {
        question: "Is the conversion done in the cloud?",
        answer:
          "No, all layout analysis and format packaging are performed locally in your browser to guarantee the absolute privacy of your documents.",
      },
    ],
  },
  "citation-linker": {
    ...
    metaDescription:
      "Quét và kích hoạt các ký hiệu trích dẫn trong PDF, chuyển đổi chúng thành liên kết DOI hoặc liên kết nội trang.",
    keywords: [
      "liên kết trích dẫn",
      "hyperlink pdf",
      "so khớp doi",
    ...
    howToUse: [
      {
        ...
        description:
          "Upload a PDF paper or thesis containing a bibliography/reference section.",
      },
      {
        step: 2,
        title: "Review Citations",
        description:
          "Inspect the citation pairs in the interactive map and manually edit or add DOI links if necessary.",
      },
      {
        step: 3,
        title: "Inject Links",
        description:
          "Click the activate button to overlay hyperlinks onto the PDF and download the updated document.",
      },
    ],
    useCases: [
      {
        ...
        description:
          "Click citation markers to immediately view reference details or navigate to external DOI pages.",
        icon: "link",
      },
      {
        title: "Pre-publication Preparation",
        description:
          "Ensure your written academic papers have fully active hyperlink navigations before final submission.",
        icon: "award",
      },
      {
        title: "Reference Map Analysis",
        description:
          "Understand literature hierarchies and connections via the interactive network topology map.",
        icon: "git-network",
      },
    ],
    faq: [
      {
        ...
        answer:
          'If a DOI cannot be found, the tool falls back to an internal "GoTo Page" action, allowing you to click the marker and jump directly to the reference page.',
      },
      {
        question: "Which citation formats are supported?",
        answer:
          "It supports common numeric brackets (e.g., [1], [1-3]) and author-year citations (e.g., Author et al., 202X).",
      },
      {
        question: "Will it modify the appearance of my PDF?",
        answer:
          "No, it injects invisible Link annotations on top of the text, preserving the original layout, fonts, and styling of your document.",
      },
    ],
  },
  "vector-extractor": {
    ...
    metaDescription:
      "Chuyển đổi PDF sang SVG độ chính xác cao, cho phép chọn và trích xuất không mất dữ liệu bất kỳ đồ họa vectơ nào.",
    keywords: [
    ...
    howToUse: [
      {
        ...
        title: "Upload PDF Document",
        description:
          "Upload a PDF containing vector assets, diagrams, charts, or logos.",
      },
      {
        step: 2,
        title: "Select Elements",
        description:
          "Hover over the vector canvas to highlight elements, then click to select a node.",
      },
      {
        step: 3,
        title: "Customize and Export",
        description:
          "Adjust path attributes in the panel, then download as SVG or copy SVG source code.",
      },
    ],
    useCases: [
      {
        ...
        description:
          "Quickly extract company logos, icons, and illustrations from brand guidelines or brochures.",
        icon: "bezier",
      },
      {
        title: "Scientific Chart Export",
        description:
          "Extract vector charts from research papers to use in high-resolution printing or presentations.",
        icon: "presentation",
      },
      {
        title: "Vector Asset Recoloring",
        description:
          "Modify the stroke and fill colors of extracted assets before saving them for web projects.",
        icon: "crown",
      },
    ],
    faq: [
      {
        ...
        answer:
          "PDFs contain both raster images (like photos or scanned pages) and vector artwork (like shapes and curves). Only vector paths can be deconstructed into SVG paths.",
      },
      {
        question: "Does the output SVG contain styles?",
        answer:
          "Yes, the exported SVG retains all original properties including fills, strokes, opacity, gradients, and coordinate transforms.",
      },
      {
        question: "Will large files lag?",
        answer:
          "We use WebAssembly acceleration, but PDFs with extremely complex CAD drawings or thousands of vector paths may take a few seconds to render.",
      },
    ],
  },
  "deep-sanitize": {
    ...
    metaDescription:
      "Xóa bỏ hoàn toàn thông tin tác giả, lịch sử chỉnh sửa, lớp ẩn và các đối tượng thừa từ cấu trúc tệp PDF.",
    keywords: [
      "làm sạch pdf",
      "xóa siêu dữ liệu",
      "bảo mật pdf",
    ...
    howToUse: [
      {
        ...
        title: "Upload PDF",
        description:
          "Select the PDF file containing sensitive data or modification history.",
      },
      {
        step: 2,
        title: "Run Scanner",
        description:
          "Trigger the 3D containment scanner to check the file for hidden metadata and layers.",
      },
      {
        step: 3,
        title: "Deep Sanitize",
        description:
          "Click sanitize to wipe out tracking elements and download the fully clean PDF.",
      },
    ],
    useCases: [
      {
        ...
        description:
          "Remove drafting records, paths, and previous revisions before sharing business contracts with third parties.",
        icon: "file-signature",
      },
      {
        title: "Anonymized Publishing",
        description:
          "Wipe invisible annotations and watermarks to publish documents anonymously and securely.",
        icon: "eye-off",
      },
      {
        title: "PDF Optimization",
        description:
          "Remove orphaned objects and garbage data streams to make files load faster on the web.",
        icon: "zap",
      },
    ],
    faq: [
      {
        ...
        answer:
          "Standard tools only clear basic fields like title or author. Deep Sanitizer reconstructs the entire PDF xref table, wiping PieceInfo, hidden watermarks, and historical incremental revisions.",
      },
      {
        question: "Will this affect document layout or text?",
        answer:
          "No, it only strips hidden description streams and structure data. The visible layout, texts, and graphics remain unchanged.",
      },
      {
        question: "Does this remove PDF passwords?",
        answer:
          "No, if a PDF is encrypted, you must unlock it first before performing a deep sanitization.",
      },
    ],
  },
  "booklet-folding-simulator": {
    ...
    metaDescription:
      "Dàn trang PDF thành các khổ giấy in lớn và trực quan hóa quy trình gấp giấy, đóng ghim sách trong không gian 3D.",
    keywords: [
      "bình trang 3d",
      "mô phỏng gấp giấy",
      "đóng ghim giữa",
    ...
    howToUse: [
      {
        ...
        title: "Upload PDF File",
        description:
          "Drag and drop the PDF document you wish to layout for printing.",
      },
      {
        step: 2,
        title: "Select Folding Layout",
        description:
          "Choose your preferred imposition scheme (e.g., 4-page fold, 8-page saddle stitch, 4-page accordion).",
      },
      {
        step: 3,
        title: "Interactive 3D Preview",
        description:
          "Drag the slider to watch the sheet fold in 3D and inspect the final page numbering layout.",
      },
      {
        step: 4,
        title: "Generate Imposed PDF",
        description:
          "Click generate to download the rearranged and merged physical sheet PDF, ready for double-sided printing.",
      },
    ],
    useCases: [
      {
        ...
        description:
          "Pre-visualize the folding sequence of tri-folds and pamphlets to prevent upsidedown pages after printing.",
        icon: "book-open",
      },
      {
        title: "Book Saddle-Stitching",
        description:
          "Generate imposed print sheets for multi-page magazines or booklets automatically.",
        icon: "layers",
      },
      {
        title: "Print Shop Visual Aids",
        description:
          "Help clients visualize how pages are physically distributed and folded on print sheets.",
        icon: "printer",
      },
    ],
    faq: [
      {
        ...
        answer:
          "Imposition is a fundamental step in prepress printing. Since commercial presses print on large sheets, pages are arranged out of order so that once printed, folded, and bound, the pages appear in the correct sequential order. This tool automatically calculates that layout.",
      },
      {
        question: "Does the 3D preview alter my PDF content?",
        answer:
          "No, the original PDF content is merely rendered as texture mappings onto the 3D sheet. The generated PDF only adjusts page order and placement; text and graphic qualities are kept intact.",
      },
      {
        question: "What if my PDF page count is not a multiple of 4 or 8?",
        answer:
          "The optimizer automatically appends blank pages at the end to satisfy the mathematical page-count requirements of the selected folding layout.",
      },
    ],
  },
  "pdf-to-slide": {
    ...
    metaDescription:
      "Phân tích bố cục tài liệu PDF để trích xuất sơ đồ vectơ và nội dung chính thành tệp trình chiếu PPTX có thể chỉnh sửa.",
    keywords: [
      "pdf sang ppt",
      "tái tạo slide",
      "trích xuất biểu đồ",
    ...
    howToUse: [
      {
        ...
        description:
          "Upload a PDF document that contains structured sections and diagrams.",
      },
      {
        step: 2,
        title: "Analyze Slide Outlines",
        description:
          "Inspect the extracted slide structure, adjust titles, or delete unneeded card blocks.",
      },
      {
        step: 3,
        title: "Reconstruct to PPTX",
        description:
          "Start the compilation engine to receive a standard, editable presentation file.",
      },
    ],
    useCases: [
      {
        ...
        description:
          "Convert academic journal PDFs, text structures, and vector diagrams into slide decks ready for talks.",
        icon: "graduation-cap",
      },
      {
        title: "Business Report Summary",
        description:
          "Distill massive annual corporate reports into clean, bulleted presentation drafts instantly.",
        icon: "presentation",
      },
      {
        title: "Multi-Device Demos",
        description:
          "Avoid copying screenshots manually. Get a clean, fully-editable layout framework in seconds.",
        icon: "laptop",
      },
    ],
    faq: [
      {
        ...
        answer:
          "Yes. The files are generated natively in memory according to the official Office Open XML (OOXML) specification. Texts, tables, and placeholders are fully interactive in PowerPoint, Keynote, and WPS.",
      },
      {
        question: "How are charts extracted?",
        answer:
          "The engine scans vector paths and raster layers in the PDF, detects bounded areas representing graphs, and clips them out as standalone SVG nodes or high-DPI images.",
      },
      {
        question: "Does this work on scanned documents?",
        answer:
          "For scanned PDFs lacking actual text layers, we recommend running our OCR tool first before passing the file to the Slide Reconstructor.",
      },
    ],
  },
  "eink-optimizer": {
    ...
    metaDescription:
      "Tối ưu hóa tài liệu PDF cho các thiết bị màn hình mực điện tử: khử nhiễu, nhị phân hóa Otsu, làm đậm nét chữ.",
    keywords: [
      "tối ưu e-ink",
    ...
    howToUse: [
      {
        ...
        description:
          "Upload e-books or scanned documents with faint text or gray backgrounds.",
      },
      {
        step: 2,
        title: "Adjust Contrast Slider",
        description:
          "Drag the damped slider to balance background removal and character bolding in real-time.",
      },
      {
        step: 3,
        title: "Optimize and Download",
        description:
          "Process the entire PDF to generate a high-contrast, eye-friendly document tailored for e-Ink.",
      },
    ],
    useCases: [
      {
        ...
        description:
          "Thicken faded text in scans of historical books or handwritten manuscripts to make them readable.",
        icon: "scroll",
      },
      {
        title: "Exam Sheet Clean-up",
        description:
          "Bleach background shadows from photocopied or photographed exams, returning clean black text on white paper.",
        icon: "file-text",
      },
      {
        title: "E-paper Device Tailoring",
        description:
          "Convert colored PDFs to optimized grayscale, preventing messy, dithering artifacts on monochrome screens.",
        icon: "tablet",
      },
    ],
    faq: [
      {
        ...
        answer:
          "In image processing, this is called dilation. It uses a structuring matrix to expand character margins by a pixel, physically thickening faint strokes to make them legible.",
      },
      {
        question: "Will this process bloat the file size?",
        answer:
          "Quite the opposite. By binarizing complex color/grayscale images to simple black-and-white layouts, standard compression (like CCITT Group 4) can shrink the PDF file size significantly.",
      },
      {
        question: "Does this support native text PDFs?",
        answer:
          "Yes. Native vector PDFs are rasterized at high resolutions in the background, optimized, and compiled back, ensuring unified high-contrast reading.",
      },
    ],
  },
  "cert-cryptor": {
    ...
    metaDescription:
      "Mã hóa PDF bằng chứng thư công khai, ký số PKCS#7 kết hợp hiệu ứng đóng dấu sáp nổi 3D cổ điển.",
    keywords: [
      "mã hóa chứng thư",
      "đóng dấu sáp 3d",
      "ký số pkcs7",
    ...
    howToUse: [
      {
        ...
        description:
          "Add your PDF and import your signing certificate (.pfx) or the recipient's public certificate (.cer).",
      },
      {
        step: 2,
        title: "Place the 3D Stamp",
        description:
          "Drag and locate the seal on the document preview, and pick a wax style (e.g., gold, crimson).",
      },
      {
        step: 3,
        title: "Press and Sign",
        description:
          "Click execute to watch the 3D wax-seal imprint ceremony, generating a physical-grade digital signature.",
      },
      {
        step: 4,
        title: "Download Secured PDF",
        description:
          "Save the output document, now cryptographically locked and stamped.",
      },
    ],
    useCases: [
      {
        ...
        description:
          "Affix highly-valued 3D wax seal badges to digital diplomas and awards, backed by genuine digital signatures.",
        icon: "award",
      },
      {
        title: "Confidential Agreements",
        description:
          "Lock sensitive contracts using the client's public certificate so that only their secure physical keycard can unlock it.",
        icon: "shield-alert",
      },
      {
        title: "Official Press Releases",
        description:
          "Digitally sign public announcements to prevent malicious text edits or spoofing.",
        icon: "stamp",
      },
    ],
    faq: [
      {
        ...
        answer:
          "Both. The system renders an incredibly realistic 3D wax imprint with normal-mapped depth (visual layer) and encodes an authentic, tamper-proof PKCS#7 cryptographic signature inside the PDF (data layer).",
      },
      {
        question: 'What is "Certificate-based Encryption"?',
        answer:
          "It is a passwordless encryption technique. You encrypt the file using the recipient's public key. The reader automatically searches for their local private certificate to decrypt the file seamlessly, ensuring robust security.",
      },
      {
        question: "Can I customize the stamp design?",
        answer:
          "Yes. We provide multiple designs like the PDFCraft watermark or a Royal crest, and you can adjust the wax melting radius and normal-map indentation depth in the panel.",
      },
    ],
  },
  "passport-id-composer": {
    ...
    metaDescription:
      "Sắp xếp hai mặt thẻ căn cước hoặc hộ chiếu lên một trang giấy A4 để in ấn, hỗ trợ đóng dấu nước chống lạm dụng.",
    keywords: [
      "ghép mặt căn cước",
    ...
    howToUse: [
      {
        ...
        description:
          "Upload front and back photos/scans of your ID or passport (up to 2 files).",
      },
      {
        step: 2,
        title: "Configure secure watermark",
        description:
          "Input custom text overlay to restrict unauthorized document replication.",
      },
      {
        step: 3,
        title: "Compose & download",
        description:
          "Click execute to generate a single-page print-ready A4 PDF.",
      },
    ],
    useCases: [
      {
        ...
        description:
          "Quickly align employee ID copies and apply protective watermarks.",
        icon: "user",
      },
      {
        title: "Government & banking service",
        description:
          "Prepare standardized ID prints that meet physical archive requirements.",
        icon: "landmark",
      },
      {
        title: "Travel backups",
        description:
          "Arrange passport pages and visa details onto a unified A4 paper.",
        icon: "plane",
      },
    ],
    faq: [
      {
        ...
        answer:
          "No. The watermark is rendered at a carefully tuned 15% opacity to block forgery without sacrificing the legibility of text or photo fields.",
      },
      {
        question: "Is the composite card size accurate?",
        answer:
          "Yes. It renders the ID card at the standard physical dimension of 85.6mm × 54mm scaled perfectly on the A4 page.",
      },
      {
  ...
  "annotation-exporter": {
    ...
    metaDescription:
      "Quét và trích xuất các nét vẽ tay, văn bản tô sáng và nhận xét từ tài liệu PDF thành ghi chú Markdown.",
    keywords: [
    ...
    howToUse: [
      {
        ...
        description:
          "Upload any PDF essay or book containing your underlines, highlights, or comments.",
      },
      {
        step: 2,
        title: "Configure filters & format",
        description:
          "Select the annotation types you want to extract and choose Markdown or JSON.",
      },
      {
        step: 3,
        title: "Extract notebook",
        description:
          "Click execute to parse the comments stream and assemble your outline summary.",
      },
    ],
    useCases: [
      {
        ...
        description:
          "Extract reading notes across multiple papers into Markdown templates to compose lit reviews instantly.",
        icon: "graduation-cap",
      },
      {
        title: "Study journal compiling",
        description:
          "Collect beautiful insights and personal remarks from textbooks into Obsidian databases.",
        icon: "book",
      },
      {
        title: "Document collaborative audit",
        description:
          "Gather review corrections from different team members and establish actionable task lists.",
        icon: "users",
      },
    ],
    faq: [
      {
        ...
        answer:
          "Yes. As long as the hand-drawn marks are stored as standard PDF Ink annotations, the tool can perfectly isolate and structure their page positions.",
      },
      {
        question: "Why are some highlighted extracts empty?",
        answer:
          "If the PDF is a non-searchable image scan lacking underlying text, highlights only store coordinates. Run OCR on the PDF first, then extract annotations.",
      },
      {
        question: "Do the Markdown links jump back to the PDF?",
        answer:
          "The exported file lists precise page numbers and original outline headings to make cross-referencing seamless.",
      },
    ],
  },
  "batch-watermark-remover": {
    ...
    metaDescription:
      "Phân tích mã nguồn nội dung PDF, loại bỏ chính xác các luồng văn bản Tj/TJ và hình ảnh XObject chứa hình mờ.",
    keywords: [
      "xóa hình mờ pdf",
    ...
    howToUse: [
      ...
      },
      {
        ...
        description:
          "Input the exact string to delete, or toggle translucent XObject image cleanup.",
      },
      {
        step: 3,
        title: "Run physical purge",
        description:
          "Click execute to scrub the content operators with high fidelity.",
      },
    ],
    useCases: [
      {
    ...
    faq: [
      {
        ...
        answer:
          "No. Unlike visual masks, we rewrite the page binary stream to erase the operators, leaving no traces.",
      },
      {
        question: "Does it support complex gradients?",
        answer:
          "If the watermark is stored as a separate text node or image XObject, the tool can isolate and physically wipe it.",
      },
      {
        question: "Will it modify normal page text?",
        answer:
          "No. The scrubbing engine only target operators matching the specified watermark signature; regular text remains untouched.",
      },
    ],
  },
  "smart-data-redactor": {
    ...
    metaDescription:
      "Tự động quét các thông tin như email, số điện thoại, căn cước, sau đó vẽ đè hộp màu đen che phủ và hủy văn bản gốc.",
    keywords: [
    ...
    howToUse: [
      {
        ...
        description:
          "Provide the contract or statement showing sensitive customer details.",
      },
      {
        step: 2,
        title: "Select redaction rules",
        description:
          "Check target patterns (email, phone, ID) or define custom sensitive words.",
      },
      {
        step: 3,
        title: "Auto redact & download",
        description:
          "Click execute to overlay secure masks and wipe the text streams.",
      },
    ],
    useCases: [
      {
        ...
        description:
          "Safely publish business documents by hiding personal salaries, phone numbers, or emails.",
        icon: "file-signature",
      },
      {
        title: "Resume database anonymization",
        description:
          "Strip applicant names, contact info, or addresses to comply with strict privacy regulations.",
        icon: "user-check",
      },
      {
        title: "Financial statement distribution",
        description:
          "Conceal specific ledger numbers or shareholder names before publishing reports.",
        icon: "pie-chart",
      },
    ],
    faq: [
      {
        ...
        answer:
          'Yes. We rewrite the page content stream to erase the characters. Copy-pasting from the redacted box will only extract the string "[REDACTED]".',
      },
      {
        question: "Does it work for scanned image PDFs?",
        answer:
          "This tool targets vector text streams. For scanned image files, use our OCR tool first or crop manually.",
      },
      {
        question: "Is the red HUD target scope saved in the file?",
        answer:
          "No, that is a gorgeous frontend interactive loading effect. The output PDF displays standard clean black rectangles.",
      },
    ],
  },
  "bookmarks-auto-generator": {
    ...
    metaDescription:
      "Phân tích kích thước và thứ bậc phông chữ trong tài liệu để tạo và nhúng cây mục lục (/Outlines) tự động.",
    keywords: ["tạo bookmark tự động", "mục lục thông minh pdf", "cây mục lục"],
    description:
    ...
    howToUse: [
      {
        ...
        description:
          "Upload large brochures, academic papers, or ebooks lacking a catalog sidebar.",
      },
      {
        step: 2,
        title: "Tune heading rules",
        description:
          "Configure strategies specifying minimum font size thresholds and match rules.",
      },
      {
        step: 3,
        title: "Build and inject",
        description:
          "Click execute to render the outline nodes and physically write the outline bookmarks.",
      },
    ],
    useCases: [
      {
        ...
        description:
          "Auto compile multi-level chapters for standard guidelines, saving hours of manual indexing.",
        icon: "tool",
      },
      {
        title: "Thesis preparation",
        description:
          "Inject clean nested bookmarks matching exact academic submission standards.",
        icon: "graduation-cap",
      },
      {
        title: "Ebook navigation optimization",
        description:
          "Structure scanned text publications into readable chapters for tablets or mobile readers.",
        icon: "tablet",
      },
    ],
    faq: [
      {
        ...
        answer:
          "Yes. You can add custom regex patterns in the sidebar panel (e.g., `^Part\\s+\\w+`) to target unique layouts.",
      },
      {
        question: "Will this affect the visual page presentation?",
        answer:
          "No. The tool only adds an internal structural bookmark catalog. The text and visual assets of the pages remain untouched.",
      },
      {
        question: "How many bookmark levels are supported?",
        answer:
          "The tool supports deeply nested bookmark structures, allowing chapter, section, and subsection layouts.",
      },
    ],
  },
  "batch-barcode-injector": {
    ...
    metaDescription:
      "Tải lên danh sách mã vạch hoặc mã QR và nhúng chúng hàng loạt vào tọa độ định sẵn trên các trang PDF.",
    keywords: ["nhúng qr hàng loạt", "chèn mã vạch pdf", "in nhãn mã vạch"],
    description:
    ...
    howToUse: [
      {
        ...
        description:
          "Drag and drop single or multi-page PDFs representing agreements or shipping lists.",
      },
      {
        step: 2,
        title: "Position barcode coordinates",
        description:
          "Set code type, value, and drag the placement box to specify coordinates.",
      },
      {
        step: 3,
        title: "Stamps and download",
        description:
          "Click execute to render the code layer onto the targeted page indices.",
      },
    ],
    useCases: [
      {
        ...
        description:
          "Apply a unique QR code showing anti-counterfeit details onto the header of contracts.",
        icon: "file-check",
      },
      {
        title: "Shipping lists coding",
        description:
          "Place Code128 barcodes at target spots for quick warehouse scanning gun validation.",
        icon: "truck",
      },
      {
        title: "Asset registration carding",
        description:
          "Add inventory QR codes displaying maintenance specs onto physical equipment sheets.",
        icon: "archive",
      },
    ],
    faq: [
      {
        ...
        answer:
          "Yes. We embed lossless high-resolution PNG representations that remain sharp even when printed at very small dimensions.",
      },
      {
        question: "Can I inject unique values on each page?",
        answer:
          "Currently, the batch run applies the same configured code onto all selected pages. Multi-valued excel import is planned in a future update.",
      },
      {
        question: "What does the `pt` coordinate represent?",
        answer:
          "`pt` (Point) is the standard PDF physical unit (72 pt = 1 inch). A4 pages are represented as 595 × 842 pt.",
      },
    ],
  },
  "signature-ink-optimizer": {
    ...
    metaDescription:
      "Trích xuất chữ ký và con dấu từ tài liệu quét, làm sạch nền và khử bóng để tạo tệp PNG nền trong suốt.",
    keywords: ["tách chữ ký", "làm trong suốt con dấu", "tách dấu đỏ png"],
    description:
    ...
    howToUse: [
      {
        ...
        description:
          "Provide a phone-captured photo of your signature or stamp seal.",
      },
      {
        step: 2,
        title: "Adjust cleaning sliders",
        description:
          "Move contrast and luminance sliders to isolate the background noise in real-time.",
      },
      {
        step: 3,
        title: "Download clean signature",
        description:
          "Export as transparent PNG ready to be stamped onto formal document agreements.",
      },
    ],
    useCases: [
      {
        ...
        description:
          "Convert gray signature photos into beautiful, transparent layers to sign agreements.",
        icon: "file-signature",
      },
      {
        title: "Corporate seal sanitizing",
        description:
          "Clean physical stamp scans by discarding paper fiber noise, preparing crisp transparent stamp seals.",
        icon: "stamp",
      },
      {
        title: "Drawn line art extraction",
        description:
          "Isolate black strokes from drawing sketchbooks for easy Photoshop coloring workflows.",
        icon: "edit",
      },
    ],
    faq: [
      {
        question:
          "How does self-adaptive Alpha extraction differ from normal keying?",
        answer:
          "Standard chroma-keying often makes signature stroke details look blocky and pixelated. Our algorithm isolates only white/yellow background noise and smooths the ink borders.",
      },
      {
        question: "Which image formats are supported?",
        answer:
          "We support JPG, JPEG, and PNG. For best results, capture your signature photo under bright, even lighting.",
      },
      {
        question: "Will the handwriting detail be modified?",
        answer:
          "No. The pixel filtering acts on original coordinates, sharpening contrast while maintaining genuine stroke textures.",
      },
    ],
  },
  "dead-link-debugger": {
    ...
    metaDescription:
      "Quét toàn bộ tài liệu PDF để tìm các liên kết (/URI) bị hỏng, cho phép sửa đổi hoặc chuyển hướng chúng.",
    keywords: ["sửa liên kết hỏng", "kiểm tra link pdf", "điều hướng url pdf"],
    description:
    ...
    howToUse: [
      {
        ...
        description:
          "Upload the PDF manual or catalog containing links to debug.",
      },
      {
        step: 2,
        title: "Scan and update",
        description:
          "Let the debugger extract all URL entities. Input new redirect URLs for broken items.",
      },
      {
        step: 3,
        title: "Save redirect updates",
        description:
          "Click execute to rewrite /URI actions and download the corrected PDF.",
      },
    ],
    useCases: [
      {
        ...
        description:
          "Instantly correct wrong urls on published flyers without reopening original design editors.",
        icon: "refresh-cw",
      },
      {
        title: "Bibliography links verification",
        description:
          "Verify academic bibliography links in reports, updating references to maintain authority.",
        icon: "book",
      },
      {
        title: "Corporate rebranding updates",
        description:
          "Batch update old URLs across corporate PDFs when company domain names are changed.",
        icon: "globe",
      },
    ],
    faq: [
      {
        ...
        answer:
          "Web browsers enforce strict CORS policies that block direct multi-origin link checking. Our tool lists the links clearly and lets you hot-fix them manually.",
      },
      {
        question:
          "Will this modify the visual text representation on the page?",
        answer:
          "No. It only alters the underlying `/URI` navigation action. The visual link text remains unchanged.",
      },
      {
        question: "Does it support modifying internal page bookmarks?",
        answer:
          "This tool handles external `/URI` hyperlinks. For internal layout navigation, use our interactive TOC tool.",
      },
    ],
  },
  "interactive-toc-generator": {
    ...
    metaDescription:
      "Chèn trang mục lục có thể nhấp để di chuyển đến các trang tương ứng, tự động thêm nút quay về mục lục (↩) ở lề trang.",
    keywords: [
    ...
    howToUse: [
      {
        ...
        description:
          "Upload a report, eBook, or proposal that needs an interactive catalog.",
      },
      {
        step: 2,
        title: "Set TOC title & index",
        description:
          "Customize the main title and choose the page index to insert the TOC page.",
      },
      {
        step: 3,
        title: "Weave anchors & save",
        description:
          "Click execute to compile the pages and write the dual-link navigation.",
      },
    ],
    useCases: [
      {
        ...
        description:
          "Inject a beautiful index page after the cover sheet to allow shareholders to jump between financial charts.",
        icon: "file-bar",
      },
      {
        title: "Thesis indexing",
        description:
          "Fast compile standard indexes aligned with university formatting rules.",
        icon: "bookmark",
      },
      {
        title: "Operation manual navigation",
        description:
          "Help handbook readers quickly jump from troubleshooting sheets back to the main TOC.",
        icon: "check-circle",
      },
    ],
    faq: [
      {
        ...
        answer:
          "We create standard Link annotations on the TOC page targeting the respective pages; then we embed a link back to the TOC page on all target chapter sheets.",
      },
      {
        question: "Will inserting the TOC page break existing page numbers?",
        answer:
          "No. The compiler accounts for the offset of the newly inserted TOC page, ensuring all target destinations align.",
      },
      {
        question: "Is the TOC page valid when printed physically?",
        answer:
          "Yes. The generated TOC lists clean physical page numbers to guide paper readers while enabling clickable links on screen.",
      },
    ],
  },
  "pdf-deskew-aligner": {
    ...
    metaDescription:
      "Tự động phát hiện góc nghiêng trong tài liệu quét hoặc ảnh chụp PDF, xoay chỉnh về hướng thẳng ngang hoàn hảo.",
    keywords: [
    ...
    howToUse: [
      {
        ...
        description:
          "Upload any PDF sheet carrying rotated or poorly aligned scanned documents.",
      },
      {
        step: 2,
        title: "Analyze and tweak",
        description:
          "The engine auto-detects skew angle and draws aligning grids. Tweak angle manually if needed.",
      },
      {
        step: 3,
        title: "Straighten & download",
        description:
          "Click execute to swing pages through a smooth gyroscope transition and download aligned PDF.",
      },
    ],
    useCases: [
      {
        ...
        description:
          "Straighten quick hand-held mobile contract scans before saving them as formal digital PDF archives.",
        icon: "file-text",
      },
      {
        title: "Academic Book Digitizing",
        description:
          "Sanitize microfilm book scans where text lines drift out of horizontal margins.",
        icon: "book",
      },
      {
        title: "Student Homework Grading",
        description:
          "Correct homework snapshots taken by student phones, relaxing the eyes of grading teachers.",
        icon: "edit-3",
      },
    ],
    faq: [
      {
        ...
        answer:
          "We run high-speed Hough Line projections on text lines. Since formal prints have clear horizontal spacing patterns, finding the angle with the maximum variance isolates the rotation.",
      },
      {
        question: "Will this process crop away page edges?",
        answer:
          "No. The engine calculates the rotated boundary and extends the Canvas using auto-padding, ensuring all margin text remains intact without cropping.",
      },
      {
        question: "Does it support documents filled with diagrams?",
        answer:
          "Yes, as long as there is an underlying structure of lines or general paragraphs, our algorithms can accurately lock onto the principal reading angle.",
      },
    ],
  },
  "pdf-two-column-reflower": {
    ...
    metaDescription:
      "Sao chép trang và giới hạn lại CropBox trái/phải để chuyển đổi tài liệu từ hai cột thành một cột thẳng đứng.",
    keywords: [
  ...
  "pdf-page-resizer-uniform": {
    ...
    metaDescription:
      "Tự động phát hiện kích thước các trang khác nhau trong PDF, phóng to/thu nhỏ đồng bộ về kích thước đích.",
    keywords: [
    ...
    howToUse: [
      {
        ...
        description:
          "Upload a merged PDF document containing mismatched, messy page sizes.",
      },
      {
        step: 2,
        title: "Choose target preset",
        description:
          "Select the target uniform size (e.g. A4, Letter, A3) and toggle scale modes.",
      },
      {
        step: 3,
        title: "Align and download",
        description:
          "Click execute to trigger 3D sheet alignment, downloading a beautifully standardized PDF.",
      },
    ],
    useCases: [
      {
        ...
        description:
          "Standardize scanned qualification certificates and A4 bidding sheets before physical printing.",
        icon: "file-text",
      },
      {
        title: "Financial Chart Integration",
        description:
          "Scale broad A3 financial cash flows into neat A4 pages, preserving printing standards.",
        icon: "layout",
      },
      {
        title: "Book Margin Standardization",
        description:
          "Force slightly varied scanned book pages into an absolutely uniform dimension for comfortable reading.",
        icon: "book",
      },
    ],
    faq: [
      {
        ...
        answer:
          'Never. We support both "Contain" (proportional scaling with white bars) and "Cover" (centered crop). The default Contain mode preserves aspect ratios, preventing distortion.',
      },
      {
        question: "Will existing forms and annotations remain clickable?",
        answer:
          "Yes. The algorithm maps the scaling factors to the Annotation coordinate arrays, scaling link boxes, sign boundaries, and inputs to align perfectly after resizing.",
      },
      {
        question: "Is there a limit on how many pages I can resize?",
        answer:
          "No. Since all operations run locally in your client sandbox using native JavaScript, you can process extensive PDFs containing hundreds of pages in seconds.",
      },
    ],
  },
  "handwriting-ink-contrast-booster": {
    ...
    metaDescription:
      "Tẩy trắng nền giấy ố vàng/tối màu, kéo giãn tương phản cục bộ cho nét viết mực xanh/đen và dấu đỏ.",
    keywords: [
    ...
    howToUse: [
      {
        ...
        description:
          "Provide a PDF containing faded signatures, handwritten diaries, or sketches.",
      },
      {
        step: 2,
        title: "Configure ink filter",
        description:
          "Select the color profile to isolate (e.g. blue ink, black ink, or both) and adjust sharpening.",
      },
      {
        step: 3,
        title: "Sharpen and download",
        description:
          "Click execute to trace colors with a radar scanner effect and download purified PDF.",
      },
    ],
    useCases: [
      {
        ...
        description:
          "Repair poorly scanned agreements, sharpening signatures and bleaching paper background to A4-pure white.",
        icon: "file-check",
      },
      {
        title: "Handwritten Manuscripts Archive",
        description:
          "Digitize written journals or diaries, extracting clear black strokes while erasing age-related stains.",
        icon: "book",
      },
      {
        title: "Historical Ledger Restoration",
        description:
          "Restore faint ink details on aged archival ledgers, rescuing valuable handwritten coordinates.",
        icon: "archive",
      },
    ],
    faq: [
      {
        ...
        answer:
          'Grayscale converts paper shadows into gray values. Our adaptive algorithm separates background luminance and isolates signature "ink spectrums," purifying the backdrop to absolute white while leaving stroke edges sharp.',
      },
      {
        question: "Will I lose handwriting stroke texture?",
        answer:
          "No. The CLAHE algorithm works on a sub-pixel level, preserving natural pen-stroke pressure, ink fading, and dynamic line weights.",
      },
      {
        question: "Can I keep red corporate stamp marks?",
        answer:
          'Yes. By enabling "Chroma Ink Preservation," the booster whitens paper background and darkens writing, while maintaining the bright colors of red seals and blue ink signatures.',
      },
    ],
  },
  "pdf-spine-bookbinder": {
    ...
    metaDescription:
      "Nhập số trang và định lượng giấy GSM để tính độ dày gáy sách theo đơn vị mm, tạo bản vẽ thiết kế bìa PDF phẳng.",
    keywords: [
    ...
    howToUse: [
      {
        ...
        description:
          "Input document page count and select the target paper stock specifications.",
      },
      {
        step: 2,
        title: "Input spine text",
        description:
          "Enter book titles, author details, and customize spine/cover backgrounds.",
      },
      {
        step: 3,
        title: "3D Preview & Export",
        description:
          "Spin and inspect your book cover in an interactive 3D binder. Export high-resolution vector PDF.",
      },
    ],
    useCases: [
      {
        ...
        description:
          "Design professional cover sheets with precise spine crease alignments for thick tender bids.",
        icon: "layers",
      },
      {
        title: "Thesis Hardcover Binding",
        description:
          "Map out perfect spine layout widths for university master/doctorate degree theses.",
        icon: "award",
      },
      {
        title: "Self-Publishing Novel Covers",
        description:
          "Calculate book spine width easily before submitting files to Print-on-Demand publishing services.",
        icon: "book-open",
      },
    ],
    faq: [
      {
        ...
        answer:
          'Highly accurate. Our physics library matches industry averages (e.g. 70 GSM = 0.09mm, 80 GSM = 0.10mm, 150 GSM glossy = 0.125mm). We also include a "Double-sided printing" toggle to halve calculations automatically.',
      },
      {
        question: "Are the exported covers ready for direct printing?",
        answer:
          "Yes. The files are vector-perfect PDFs carrying standard registration marks, color bars, and spine guides, fully compliant with offset and digital commercial presses.",
      },
      {
        question: "Can I upload a background image spanning the spine?",
        answer:
          "Yes. You can upload custom layouts, and our compositor will wrap and align the graphics across the spine folds automatically.",
      },
    ],
  },
  "pdf-signature-anchor-helper": {
    ...
    metaDescription:
      "Định vị chính xác và nhúng con dấu chỉ dẫn ký tên kèm theo các liên kết nhảy tương tác trực tiếp tới vị trí ký.",
    keywords: ["hướng dẫn ký tên pdf", "neo vị trí ký", "ký tên liên kết"],
    description:
    ...
    howToUse: [
      {
        ...
        description:
          "Upload the PDF contract or NDA that needs signature coordinates.",
      },
      {
        step: 2,
        title: "Auto-scan signature slots",
        description:
          "Inspect the automatically located signing boxes, and manually add custom sign points if needed.",
      },
      {
        step: 3,
        title: "Inject anchors & save",
        description:
          "Click execute to write the interactive pointer layers into the PDF structure.",
      },
    ],
    useCases: [
      {
        ...
        description:
          "Inject clear, flashing guides next to sign blocks to prevent onboarding employees from missing clauses.",
        icon: "file-text",
      },
      {
        title: "Commercial Lease Contracts",
        description:
          "Guide multiple co-signers through multi-page real estate documents with custom-colored tabs.",
        icon: "users",
      },
      {
        title: "Procurement PO Signatures",
        description:
          "Overlay interactive pointers on invoices and purchase orders to accelerate accounting approval loops.",
        icon: "briefcase",
      },
    ],
    faq: [
      {
        ...
        answer:
          "No. The anchors are injected with the standard PDF `Printable` flag set to false. They display beautifully on computer/tablet screens but remain completely invisible when printed.",
      },
      {
        question: "Can clients jump between signature fields easily?",
        answer:
          'Yes. We weave bidirectional internal anchors. Clients can click the "Sign Guide" bookmark to automatically jump to the next empty signature slot instantly.',
      },
      {
        question: "Does this work on scanned image documents?",
        answer:
          "Yes. Besides looking up text streams, our spatial layout parser estimates signature lines based on horizontal rules and bounding boxes on scanned sheets.",
      },
    ],
  },
  "pdf-lossless-slicer": {
    ...
    metaDescription:
      "Định hình lại không gian MediaBox và CropBox để cắt các phần bản vẽ CAD lớn mà không làm vỡ các đường nét vectơ.",
    keywords: ["cắt bản vẽ lớn pdf", "cắt không mất dữ liệu", "cropbox bản vẽ"],
    description:
    ...
    howToUse: [
      {
        ...
        description:
          "Upload the vector-rich CAD, GIS map, or high-resolution catalog PDF.",
      },
      {
        step: 2,
        title: "Draw cutting box",
        description:
          "Drag and scale the green laser-line crop box to target the local region you want to slice.",
      },
      {
        step: 3,
        title: "Trigger laser crop",
        description:
          "Click execute to trigger our low-level object slicer and download the tiny, lossless PDF.",
      },
    ],
    useCases: [
      {
        ...
        description:
          'Slice out a "cooling system" detail from a massive 100MB floor plan blueprint to share with sub-contractors.',
        icon: "crop",
      },
      {
        title: "GIS Map Snipping",
        description:
          "Extract a lossless, vector-clear block of a city street map for a presentation slide without resolution loss.",
        icon: "map",
      },
      {
        title: "Manual Illustration Tracing",
        description:
          "Lossless isolate scientific book figures to embed into high-quality academic papers.",
        icon: "image",
      },
    ],
    faq: [
      {
        ...
        answer:
          "Standard cropping merely adjusts visual bounds; the hidden vectors remain in the file. Our slicer trims overlapping vector paths and purges out-of-bounds XObject images, ensuring complete data isolation and maximum file compression.",
      },
      {
        question: "Will text layers remain searchable?",
        answer:
          "Yes. Any text characters that fall inside the sliced boundary remain fully vector-clear, searchable, and selectable.",
      },
      {
        question: "Can I export sliced regions to SVG?",
        answer:
          "The output is a standardized vector PDF. You can pass the resulting file to our PDF-to-SVG tool to convert it to a web-scalable vector graphics format.",
      },
    ],
  },
  "pdf-scratchpad-canvas": {
    ...
    metaDescription:
      "Tăng chiều rộng hoặc chiều cao trang PDF, ghép thêm một dải lề nháp 200 pt mang họa tiết kẻ ngang hoặc ô lưới.",
    keywords: [
      "chèn lề nháp pdf",
    ...
    howToUse: [
      ...
      },
      {
        ...
        description:
          "Pick margin expansion direction (e.g. right side for tablets) and select the grid template.",
      },
      {
        step: 3,
        title: "Stitch canvas & download",
        description:
          "Click execute to generate expanded pages complete with beautiful draft grids.",
      },
    ],
    useCases: [
      {
        ...
        description:
          "Stitch grid margins next to math and physics exam questions, solving derivations right next to the question.",
        icon: "edit-3",
      },
      {
        title: "Language Reading Analysis",
        description:
          "Add ruled notebook margins next to foreign language essays for vocabulary analysis and paragraph translation.",
        icon: "book",
      },
      {
        title: "Architectural Blueprint Audit",
        description:
          "Add empty margin spaces on the side of blueprints for engineering calculations and client review comments.",
        icon: "columns",
      },
    ],
    faq: [
      {
        ...
        answer:
          "Not at all. The algorithm expands the paper dimension outwards. The original content retains its layout, fonts, and resolution; we simply stretch the white space on the borders and draw grids on them.",
      },
      {
        question: "Can standard hand-writing pens write in the scratchpad?",
        answer:
          "Yes. The new PDF pages are compiled natively. Popular tablet note-taking applications like Goodnotes, Notability, Xodo, and Acrobat can write, highlight, and doodle directly in the new grid space.",
      },
      {
        question: "Are grid lines dark and distracting?",
        answer:
          "We curated three subtle, eye-friendly colors (soft blue-gray, warm brown, and glowing green). The lines are thin and gentle, serving as guides without distracting you from the original page content.",
      },
    ],
  },
  "photo-tiling-prepress": {
    ...
    metaDescription:
      "Tự động sắp xếp ảnh thẻ thành ma trận khít trên các khổ giấy ảnh 5 inch hoặc 6 inch, hỗ trợ chèn đường cắt.",
    keywords: ["in ảnh thẻ", "Xếp ảnh thẻ in giấy ảnh", "đường viền cắt ảnh"],
    description:
    ...
    howToUse: [
      {
        ...
        description:
          "Upload the camera portrait snapshot or double-sided ID card images.",
      },
      {
        step: 2,
        title: "Configure paper & layout",
        description:
          'Select the target print paper size (e.g. 6") and choose the grid layouts (e.g. 8 copies of 1" photos).',
      },
      {
        step: 3,
        title: "Tile and export",
        description:
          "Inspect photo tiles on our grid, and export the high-DPI printable PDF.",
      },
    ],
    useCases: [
      {
        ...
        description:
          'Arrange your mobile-shot passport portraits onto a single 6" photo paper grid, and print 8 copies for a fraction of standard studio costs.',
        icon: "user",
      },
      {
        title: "ID Card Double-sided Copy",
        description:
          "Format front and back scans of national ID cards neatly on standard Letter/A4 sheets for official submissions.",
        icon: "file-text",
      },
      {
        title: "Batch Photo Thumbnail Sheets",
        description:
          "Tile multiple family memories or design snapshots onto a grid paper to print thumbnail contact sheets efficiently.",
        icon: "grid",
      },
    ],
    faq: [
      {
        ...
        answer:
          'Yes. The grid engine measures using standard PDF points (72 pt = 1 inch), rendering 1" photos exactly at 25x35mm, and 2" photos at 35x49mm. Ensure you print at "Actual Size / 100% Scale" in your printer settings.',
      },
      {
        question: 'Can I combine 1" and 2" photos on a single sheet?',
        answer:
          'Yes. We provide curated hybrid layout presets (e.g. "4 copies of 1" + 4 copies of 2""), allowing you to maximize photo paper space.',
      },
      {
        question: "Does the template include border bleeds?",
        answer:
          "Yes. The prepress layouts reserve a standard 4mm print-safe margin on the paper borders, preventing physical printer rollers from cropping the photos.",
      },
    ],
  },
  "find-and-redact": {
    ...
    metaDescription:
      "Tìm kiếm và che khuất văn bản trên tất cả các trang của PDF. Che khuất hàng loạt thông tin nhạy cảm như số tài khoản, tên, v.v.",
    keywords: [
      "che khuất pdf",
      "tìm và che khuất",
      "che khuất hàng loạt",
    ...
    howToUse: [
      ...
      },
      {
        ...
        description:
          "Nhập văn bản, số hoặc mẫu biểu thức chính quy (regex) mà bạn muốn tìm và che khuất.",
      },
      {
        step: 3,
        title: "Xem lại và lựa chọn",
        description:
          "Xem trước tất cả kết quả khớp và chọn các mục bạn muốn che khuất.",
      },
      {
        step: 4,
        title: "Áp dụng che khuất",
        description:
          "Tùy chỉnh giao diện che khuất và áp dụng cho các kết quả đã chọn.",
      },
    ],
    useCases: [
      {
        ...
        description:
          "Che khuất thông tin cá nhân để tuân thủ GDPR, HIPAA hoặc các quy định khác.",
        icon: "shield",
      },
      {
        title: "Tài liệu pháp lý",
        description:
          "Loại bỏ dữ liệu mật khỏi các tài liệu pháp lý trước khi chia sẻ.",
        icon: "scale",
      },
      {
        title: "Bản ghi tài chính",
        description:
          "Che khuất số tài khoản, số định danh cá nhân (SSN) hoặc dữ liệu tài chính khỏi các bản sao kê.",
        icon: "credit-card",
      },
    ],
    faq: [
      {
        ...
        answer:
          "Có, việc che khuất sẽ xóa vĩnh viễn văn bản nằm bên dưới. Nội dung gốc không thể khôi phục lại được. Hãy luôn sao lưu tệp gốc trước khi thực hiện.",
      },
      {
        question:
          "Tôi có thể che khuất hình ảnh hoặc văn bản quét (scanned text) không?",
        answer:
          "Công cụ này hoạt động trên các tệp PDF dạng văn bản. Đối với tài liệu quét, bạn cần sử dụng tính năng che khuất vùng thủ công.",
      },
      {
        question: "Tôi có thể tùy chỉnh giao diện của phần che khuất không?",
        answer:
          'Có, bạn có thể thiết lập màu sắc của vùng che khuất, thêm viền và tùy chọn thêm văn bản thay thế như "[ĐÃ CHE]" hoặc "[ĐÃ KIỂM DUYỆT]".',
      },
      {
        question:
          "Tìm kiếm bằng biểu thức chính quy (regex) hoạt động thế nào?",
        answer:
          'Bật "Sử dụng biểu thức chính quy" để tìm kiếm bằng các mẫu regex. Ví dụ: sử dụng \\d{4}-\\d{4}-\\d{4}-\\d{4} để tìm số thẻ tín dụng.',
      },
    ],
  },
  "pdf-to-markdown": {
    ...
    metaDescription:
      "Chuyển đổi PDF sang định dạng Markdown. Trích xuất văn bản và giữ nguyên các định dạng như tiêu đề và danh sách.",
    keywords: [
    ...
    howToUse: [
      ...
      },
      {
        ...
        description:
          "Đặt phạm vi trang, chọn có bao gồm số trang hay không và điều chỉnh cài đặt ngắt dòng.",
      },
      {
        step: 3,
        title: "Chuyển đổi và tải xuống",
        description:
          "Nhấp vào Chuyển đổi để tạo tệp Markdown của bạn và tải xuống.",
      },
    ],
    useCases: [
      {
        title: "Làm tài liệu",
        description:
          "Chuyển đổi tài liệu hướng dẫn và cẩm nang PDF sang Markdown để quản lý phiên bản.",
        icon: "file-text",
      },
      {
        title: "Ghi chú",
        description:
          "Trích xuất nội dung từ các bài báo và sách PDF cho hệ thống ghi chú của bạn.",
        icon: "edit-3",
      },
      {
        title: "Di trú nội dung",
        description:
          "Chuyển đổi nội dung PDF sang các nền tảng CMS hỗ trợ Markdown.",
        icon: "copy",
      },
    ],
    faq: [
      {
        ...
        answer:
          "Công cụ cố gắng phát hiện các tiêu đề dựa trên kích thước phông chữ và các danh sách dạng ký tự/số. Các bố cục phức tạp có thể cần điều chỉnh thủ công.",
      },
      {
        question: "Tôi có thể chuyển đổi các trang cụ thể không?",
        answer:
          'Có, bạn có thể chỉ định phạm vi trang như "1-3, 5, 7" để chỉ chuyển đổi các trang đó.',
      },
      {
        question:
          "Công cụ có hoạt động với các tài liệu PDF quét (scanned) không?",
        answer:
          "Các tài liệu PDF quét chứa hình ảnh chứ không phải văn bản. Vui lòng sử dụng công cụ OCR của chúng tôi trước để trích xuất văn bản trước khi chuyển sang Markdown.",
      },
    ],
  },
  "digital-sign-pdf": {
    title: "Chữ ký số PDF",
    metaDescription:
      "Thêm chữ ký số X.509 vào tài liệu PDF. Ký PDF bằng chứng thư số PFX, P12 hoặc PEM để đảm bảo tính pháp lý.",
    keywords: [
      "chữ ký số pdf",
      "chứng thư số x509",
      "ký pdf bằng pfx",
    ...
    howToUse: [
      ...
      },
      {
        ...
        description:
          "Tải lên tệp chứng thư số X.509 của bạn (.pfx, .p12 hoặc .pem) và nhập mật khẩu tương ứng.",
      },
      {
        step: 3,
        title: "Cấu hình chữ ký",
        description:
          "Tùy chọn thêm lý do ký, địa điểm và chữ ký hiển thị với văn bản hoặc hình ảnh tùy chỉnh.",
      },
      {
        step: 4,
        title: "Ký và tải xuống",
        description:
          "Nhấp vào Ký PDF để áp dụng chữ ký số và tải xuống tài liệu đã ký.",
      },
    ],
    useCases: [
      {
        title: "Tài liệu pháp lý",
        description:
          "Ký kết hợp đồng, thỏa thuận và tài liệu pháp lý bằng chữ ký số có tính ràng buộc pháp lý.",
        icon: "scale",
      },
      {
        title: "Phê duyệt kinh doanh",
        description:
          "Ký số hóa đơn, đơn đặt hàng và tài liệu phê duyệt để phục vụ đối chiếu, kiểm toán.",
        icon: "briefcase",
      },
      {
        title: "Toàn vẹn tài liệu",
        description:
          "Đảm bảo rằng tài liệu không bị thay đổi hoặc giả mạo sau khi đã ký.",
        icon: "shield-check",
      },
    ],
    faq: [
      {
        ...
        answer:
          "Hỗ trợ các định dạng chứng thư số PFX (.pfx), PKCS#12 (.p12) và PEM (.pem).",
      },
      {
        question: "Chữ ký số này có giá trị pháp lý không?",
        answer:
          "Có, chữ ký số X.509 được công nhận về mặt pháp lý ở hầu hết các quốc gia và vùng lãnh thổ khi sử dụng chứng thư số hợp lệ.",
      },
      {
        question: "Tôi có thể thêm chữ ký hiển thị trực quan không?",
        answer:
          "Có, bạn có thể thêm hình ảnh chữ ký hoặc văn bản hiển thị kèm theo tùy chỉnh vị trí, kiểu dáng.",
      },
    ],
  },
  "validate-signature": {
    ...
    metaDescription:
      "Kiểm tra và xác minh chữ ký số trong tài liệu PDF. Xem tính hợp lệ của chứng thư số, thông tin người ký và tính toàn vẹn của tài liệu.",
    keywords: [
      "xác minh chữ ký pdf",
      "kiểm tra chữ ký số",
    ...
    howToUse: [
      ...
      },
      {
        ...
        title: "Xem kết quả",
        description:
          "Xem tất cả chữ ký được tìm thấy trong tài liệu cùng với trạng thái hiệu lực của chúng.",
      },
      {
        step: 3,
        title: "Kiểm tra chi tiết",
        description:
          "Xem chi tiết chứng thư số, thông tin người ký và dấu thời gian ký.",
      },
      {
        step: 4,
        title: "Xuất báo cáo",
        description:
          "Tùy chọn tải xuống báo cáo kết quả xác minh dưới định dạng JSON.",
      },
    ],
    useCases: [
      {
        ...
        description:
          "Xác minh rằng tài liệu đã ký là thật và không bị giả mạo hay chỉnh sửa trái phép.",
        icon: "shield-check",
      },
      {
        title: "Kiểm toán tuân thủ",
        description:
          "Kiểm tra tính hợp lệ của chữ ký phục vụ cho mục đích tuân thủ quy trình và kiểm toán.",
        icon: "clipboard-check",
      },
      {
        title: "Xem xét chứng thư số",
        description:
          "Xem thông tin chi tiết và ngày hết hạn của chứng thư số đã dùng để ký tài liệu.",
        icon: "award",
      },
    ],
    faq: [
      {
        ...
        answer:
          "Chữ ký hợp lệ nghĩa là tài liệu chưa bị chỉnh sửa kể từ thời điểm ký và chuỗi chứng thư số vẫn nguyên vẹn, đáng tin cậy.",
      },
      {
        question: "Tôi có thể xác minh nhiều tài liệu PDF cùng lúc không?",
        answer:
          "Có, bạn có thể tải lên nhiều tệp PDF và xác minh hàng loạt tất cả các chữ ký.",
      },
      {
        question: "Tại sao chữ ký lại báo không hợp lệ?",
        answer:
          "Chữ ký có thể không hợp lệ nếu tài liệu đã bị sửa đổi sau khi ký, chứng thư số hết hạn hoặc chứng thư số đó không được hệ thống tin cậy.",
      },
    ],
  },
};
