            ...
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="relative max-w-2xl mx-auto">
                <div className="relative group">
                  <Search
                    className="absolute left-5 top-1/2 -translate-y-1/2 h-5 w-5 text-[hsl(var(--color-primary))] group-focus-within:text-[hsl(var(--color-primary))] transition-colors z-10"
                    aria-hidden="true"
                  />
                  <input
                    type="search"
          ...
          <div className="container mx-auto px-4">
                ...
                {categories.map((cat) => (
                  ...
                  >
                    ...
                    {cat.value === "favorites" && favoritesLoaded && (
                      <span
                        className={`ml-0.5 text-xs ${selectedCategory === cat.value ? "opacity-100" : "opacity-60"}`}
                      >
                        ({favoritesCount})
                      </span>
                    )}
            ...
            <div className="mb-6 px-2">
              <p className="text-sm text-[hsl(var(--color-muted-foreground))]">
                ...
                {searchQuery &&
                  ` ${t("toolsPage.forQuery", { query: searchQuery })}`}
                {selectedCategory !== "all" &&
                  selectedCategory !== "favorites" &&
                  ` ${t("toolsPage.inCategory", { category: t(`home.categories.${categoryTranslationKeys[selectedCategory as ToolCategory]}`) })}`}
              </p>
            </div>
              ...
              <Card className="p-16 text-center glass-card border-dashed border-2">
                <div className="max-w-md mx-auto flex flex-col items-center">
                  <div className="w-20 h-20 bg-[hsl(var(--color-muted))] rounded-full flex items-center justify-center mb-6">
                    <Search
                      className="h-10 w-10 text-[hsl(var(--color-muted-foreground))]"
                      aria-hidden="true"
                    />
                  </div>
                  <h3 className="text-xl font-bold text-[hsl(var(--color-foreground))] mb-2">
