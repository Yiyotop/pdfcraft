...
export function RotatePDFTool({ className = "" }: RotatePDFToolProps) {
  ...
  const [calibrationTab, setCalibrationTab] = useState<"preset" | "stepless">(
    "preset",
  );
  ...
  const handleSelectOdd = useCallback(() => {
    const odds = Array.from({ length: totalPages }, (_, i) => i + 1).filter(
      (num) => num % 2 !== 0,
    );
  ...
  const handleSelectEven = useCallback(() => {
    const evens = Array.from({ length: totalPages }, (_, i) => i + 1).filter(
      (num) => num % 2 === 0,
    );
   ...
   */
  const handleApplyPresetRotation = useCallback(
    (angle: number) => {
      const target =
   ...
   */
  const handleApplyAbsoluteRotation = useCallback(
    (angle: number) => {
      const target =
        selectedPages.size > 0
          ? selectedPages
    ...
    <div className={`space-y-6 ${className}`.trim()}>
      ...
      {!file && (
        <FileUploader
          ...
          description={
            tTools("rotatePdf.uploadDescription") ||
                      ...
                      >
                        ...
                        >
                          <path
                            ...
                            strokeLinejoin="round"
                            strokeWidth={2}
                            d="M4 4v5h.582m15.356 2A8.001 8.001 0 1121.21 7.89H17.5"
                          />
                        </svg>
                        {t("rotate.rotate180")}
                      </Button>
                      ...
                      >
                        ...
                        >
                          {Array.from({ length: 12 }, (_, i) => {
                            ...
                            const x2 =
                              50 + (i % 3 === 0 ? 33 : 36) * Math.cos(angle);
                            const y2 =
                              50 + (i % 3 === 0 ? 33 : 36) * Math.sin(angle);
                            return (
                              <line
                                key={i}
                                x1={x1}
                                ...
                                stroke={
                                  i % 3 === 0
                                    ...
                                    : "hsl(var(--color-muted-foreground)/0.3)"
                                }
                        ...
                        <div
                          ...
                          style={{
                            transform: `rotate(${parseFloat(steplessAngle) || 0}deg)`,
                          }}
                        >
                      ...
                      <div className="flex items-center bg-[hsl(var(--color-muted)/0.4)] border border-[hsl(var(--color-input))] rounded-[var(--radius-md)] overflow-hidden pr-2">
                        <button
                          ...
                          onClick={() => {
                            const val = Math.max(
                              -180,
                              (parseFloat(steplessAngle) || 0) - 0.5,
                            );
                        ...
                        <div className="relative flex items-center max-w-[70px]">
                          ...
                          />
                          <span className="absolute right-0.5 text-xs text-[hsl(var(--color-muted-foreground))] select-none">
                            °
                          </span>
                        </div>
                  ...
                  {pagePreviews.map((preview) => {
                    ...
                    return (
                      <div
                        ...
                        onClick={() =>
                          handleToggleSelectPage(preview.pageNumber)
                        }
                          ...
                          <div
                            ...
                            style={{
                              ...
                              transitionTimingFunction:
                                "cubic-bezier(0.175, 0.885, 0.32, 1.275)", // Elastic bounce effect
                            }}
                          >
                            {preview.thumbnail ? (
                              <Image
                                ...
                                className="object-contain shadow-[var(--shadow-sm)] rounded-[var(--radius-sm)] pointer-events-none"
                              />
                            ) : (
