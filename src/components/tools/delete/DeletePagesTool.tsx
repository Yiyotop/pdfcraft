    ...
    <div className={`space-y-6 ${className}`.trim()}>
      ...
      {!file && (
        <FileUploader
          ...
          description={
            tTools("deletePages.uploadDescription") ||
        ...
        <Card variant="outlined" size="lg">
          ...
          <div className="mb-4 p-3 rounded-[var(--radius-md)] bg-amber-50 border border-amber-200 text-amber-800">
            <p className="text-sm">
              ...
              {tTools("deletePages.warningText") ||
                "Selected pages will be permanently removed from the PDF. At least one page must remain."}
            </p>
          </div>
          ...
          <p className="text-sm text-[hsl(var(--color-muted-foreground))] mb-4">
            {tTools("deletePages.selectHint") ||
              "Click pages to select them for deletion, or enter page numbers/ranges above."}
          </p>
        ...
        <div className="flex flex-wrap items-center gap-4">
          ...
          >
            {isProcessing
              ...
              : tTools("deletePages.deleteButton") ||
      ...
      {status === "complete" && result && (
        ...
        >
          <p className="text-sm font-medium">
            {tTools("deletePages.successMessage") ||
              `Successfully deleted ${selectedPages.size} page(s)! The PDF now has ${remainingPages} page(s). Click the download button to save your file.`}
          </p>
        </div>
      )}
    </div>
