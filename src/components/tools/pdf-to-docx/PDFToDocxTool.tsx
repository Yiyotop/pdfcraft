  ...
  return (
    <div className={`space-y-8 ${className}`.trim()}>
      ...
      <FileUploader
        ...
        description={
          tTools("pdfToDocx.uploadDescription") ||
      ...
      {status === "complete" && result && (
        ...
        >
          ...
          <h3 className="text-lg font-semibold mb-2">
            {tTools("successTitle") || "Conversion Successful!"}
          </h3>
          <p className="text-green-800/80 max-w-md mx-auto">
            {tTools("pdfToDocx.successMessage") ||
              "Your PDF has been converted to DOCX. You can now download the editable Word document."}
          </p>
        </div>
      )}
    </div>
